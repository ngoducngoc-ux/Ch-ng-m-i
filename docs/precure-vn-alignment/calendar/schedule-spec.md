...
|------|------------|-----------|--------------|
| `precure-daily-check` | `30 0 * * *` | 07:30 | Renew 2026-09-16 · `sub_f134af30-…` · tip → L1L2L3 + NatMed if STREAK&lt;3 |

Prompt: `RITUAL-HANDOFF-INDEX` · `PI-NEXT-45MIN` · STREAK · không đóng goal.

**Google series description đã cập nhật 2026-09-16 (anti-forget densify):** Daily/Weekly → **`L1L2L3-SCIENCE-CARD`** · **`CLIN_EVENT-SCIENCE-CARD`** · **`ALERT-SCIENCE-CARD`** · **`NATMED-STREAK3-SCIENCE-CARD`** · **`STREAK3-FILL-AID`** · PREP≠DONE.  
**Email PI:** Outlook → ngoducngoc@gmail.com 2026-09-16 (L1L2L3 cổng · STREAK3 path).
