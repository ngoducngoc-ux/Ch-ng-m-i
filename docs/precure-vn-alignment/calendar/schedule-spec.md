...
|------|------------|-----------|--------------|
| `precure-daily-check` | `30 0 * * *` | 07:30 | Renew 2026-09-16 · `sub_d9b4af6e…` · tip → TRIPOD-SYNTH-EQ + NatMed if STREAK&lt;3 |
...
**Email PI:** Outlook → ngoducngoc@gmail.com 2026-09-16 ×112 (SYNTH-EQ · TRANSLATION-EQ · NatMed · STREAK≥3 T4/T5).
