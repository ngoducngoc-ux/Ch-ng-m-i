...
|------|------------|-----------|--------------|
| `precure-daily-check` | `30 0 * * *` | 07:30 | Renew 2026-09-16 · `sub_ccd34212-…` · ENDPOINTS-WEEK1 + SCIENCE-CARDS-INDEX · NatMed if STREAK&lt;3 |

Prompt: `RITUAL-HANDOFF-INDEX` · `PI-NEXT-45MIN` · STREAK · không đóng goal.

**Google series description đã cập nhật 2026-09-16 (anti-forget densify):** Daily/Weekly → **`ENDPOINTS-WEEK1-SCIENCE-CARD`** · **`SCIENCE-CARDS-INDEX`** · **`PEA-WEEK1`** · **`NATMED-STREAK3-SCIENCE-CARD`** · **`STREAK3-FILL-AID`** · PREP≠DONE.  
**Email PI:** Outlook → ngoducngoc@gmail.com 2026-09-16 (ENDPOINTS-WEEK1 · STREAK3 path).
