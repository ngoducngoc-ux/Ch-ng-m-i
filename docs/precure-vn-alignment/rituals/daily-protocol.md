...
- EQ-SIBLING-MAP science: `worksheets/EQ-SIBLING-MAP-SCIENCE-CARD-v0.1.md` (STREAK≥3 · bank đóng · định tuyến ×EQ · 1 sibling)
...
- SHIFT-PB007-EQ science: `worksheets/SHIFT-PB007-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T2–T6/CN · lệch hướng · Z rồi X × ladder)
- ALERT-CROSS-EQ science: `worksheets/ALERT-CROSS-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T2/T4/T6/CN · alert×schema × ladder · ≠ Dx)
- NATMED-ALERT-EQ science: `worksheets/NATMED-ALERT-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T2 · A1–A4 × ladder · ≠ Dx)
...
- ALERT-EQ science: `worksheets/ALERT-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T2/T4/T6 · actionable × ladder · ≠ Dx)
- EPI-EQ science: `worksheets/EPI-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T2 · early window × ladder · ≠ PCT_D21)
- VAS-EQ science: `worksheets/VAS-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T4 · 0–10 × ladder · ≠ VAS_D3 early)
...
- CROSS-EQ science: `worksheets/CROSS-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T4/T6/CN · schema t*/Z × ladder · ≠ gộp Y)
...
- PB007-EQ science: `worksheets/PB007-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T2/T4/T6/T3/CN · framework × ladder · ≠ AUROC chọn cờ)
- PB008-EQ science: `worksheets/PB008-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T7/T2/CN · Hawthorne × ladder · ≠ primary)
- TRIPOD-EQ science: `worksheets/TRIPOD-EQ-SCIENCE-CARD-v0.1.md` (STREAK≥3 · T4/T5 · AI claim × ladder · demo ≠ BN)
- STREAK3-EQ science: `worksheets/STREAK3-EQ-SCIENCE-CARD-v0.1.md` (STREAK&lt;3 · mọi/CN · path × ladder · ≠ DONE trên PREP)
...
- EQ sibling map: `worksheets/EQ-SIBLING-MAP-v0.1.md` (refresh v0.1b · bank CLOSED · base→sibling ×EQ)
