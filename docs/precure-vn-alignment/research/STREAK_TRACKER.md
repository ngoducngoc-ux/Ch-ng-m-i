...
> **Sau STREAK≥3:** **`AFTER-STREAK3-OPENER-1PAGE`** · **`SCIENCE-CARDS-INDEX`** · `DAILY-STACK-AFTER-STREAK3` (T3=`L1L2L3`/`G2`/`OMICS-GATES`/`PEA-WEEK1`/`PREANALYTIC` · T4/T6=`ENDPOINTS`/`LEAKAGE`/`ALERT`/`EQ` · T5=`DESIGN-WEEK1`/`PB004`/`MISSINGNESS`/`ICF-NEST`/`SPIRIT-G1`/`AMENDMENT-ES`/`SAP-ES`/`ISO-SWAB`/`TT43`/`CONSORT`/`TRIPOD` · T7=`CLIN_EVENT`/`BN-VISIT`/`PB004`) · MISS → `#14` · **`SHIFT-SCIENCE-CARD`** · **`SYNTH-SCIENCE-CARD`** · **`OMICS-GATES-SCIENCE-CARD`** · **`AI-STACK-SCIENCE-CARD`** · **`DEID-SCIENCE-CARD`** · **`HAWTHORNE-SCIENCE-CARD`** · **`BN-VISIT-SCIENCE-CARD`** · **`PB004-SCIENCE-CARD`** · **`MEDIA-SCIENCE-CARD`** · **`MISSINGNESS-SCIENCE-CARD`** · **`ICF-NEST-SCIENCE-CARD`** · **`TRIPOD-SCIENCE-CARD`** · **`SPIRIT-G1-SCIENCE-CARD`** · **`AMENDMENT-ES-SCIENCE-CARD`** · **`TT43-SCIENCE-CARD`** · **`CONSORT-SCIENCE-CARD`** · **`SAP-ES-SCIENCE-CARD`** · **`ISO-SWAB-SCIENCE-CARD`** · **`PREANALYTIC-SCIENCE-CARD`** · **`PITFALLS-SCIENCE-CARD`** · **PREP ≠ DONE:** `RITUAL-DONE-vs-PREP.md`  
...
- **Renewed:** 2026-09-16 (lần 120) · `sub_1fbe0360-4df3-4513-838e-0ef51edee393` · tip → **PITFALLS-SCIENCE-CARD** + NatMed priority if STREAK&lt;3
