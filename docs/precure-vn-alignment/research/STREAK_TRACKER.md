...
> **Sau STREAK≥3:** **`AFTER-STREAK3-OPENER-1PAGE`** · **`SCIENCE-CARDS-INDEX`** · `DAILY-STACK-AFTER-STREAK3` (T3=`L1L2L3`/`G2`/`OMICS-GATES`/`PEA-WEEK1` · T4/T6=`ENDPOINTS`/`LEAKAGE`/`ALERT`/`EQ` · T5=`DESIGN-WEEK1`/`PB004`/`MISSINGNESS`/`ICF-NEST`/`SPIRIT-G1`/`AMENDMENT-ES`/`TT43`/`TRIPOD` · T7=`CLIN_EVENT`/`BN-VISIT`/`PB004`) · MISS → `#14` · **`SHIFT-SCIENCE-CARD`** · **`SYNTH-SCIENCE-CARD`** · **`OMICS-GATES-SCIENCE-CARD`** · **`AI-STACK-SCIENCE-CARD`** · **`DEID-SCIENCE-CARD`** · **`HAWTHORNE-SCIENCE-CARD`** · **`BN-VISIT-SCIENCE-CARD`** · **`PB004-SCIENCE-CARD`** · **`MEDIA-SCIENCE-CARD`** · **`MISSINGNESS-SCIENCE-CARD`** · **`ICF-NEST-SCIENCE-CARD`** · **`TRIPOD-SCIENCE-CARD`** · **`SPIRIT-G1-SCIENCE-CARD`** · **`AMENDMENT-ES-SCIENCE-CARD`** · **`TT43-SCIENCE-CARD`** · **PREP ≠ DONE:** `RITUAL-DONE-vs-PREP.md`  
...
- **Renewed:** 2026-09-16 (lần 115) · `sub_349e3f3d-…` · tip → **TT43-SCIENCE-CARD** + NatMed priority if STREAK&lt;3
