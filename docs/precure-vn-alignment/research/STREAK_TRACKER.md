...
> **PI ritual tiếp theo:** **`STREAK3-NOW-1PAGE`** · **`NATMED-STREAK3-SCIENCE-CARD`** · **`ALERT-SCIENCE-CARD`** · **`HAWTHORNE-SCIENCE-CARD`** · **`STREAK3-FILL-AID`** · `../PI-NEXT-45MIN.md` · script `PI-SESSION-SCRIPT-STREAK3` · log `2026-09-19.md`  
> **Sau STREAK≥3:** **`AFTER-STREAK3-OPENER-1PAGE`** · **`SCIENCE-CARDS-INDEX`** · `DAILY-STACK-AFTER-STREAK3` (T3=`L1L2L3`/`G2`/`OMICS-GATES`/`PEA-WEEK1` · T4/T6=`ENDPOINTS`/`LEAKAGE`/`ALERT`/`EQ` · T5=`DESIGN-WEEK1`/`PB004` · T7=`CLIN_EVENT`/`BN-VISIT`/`PB004`) · MISS → `#14` · **`SHIFT-SCIENCE-CARD`** · **`SYNTH-SCIENCE-CARD`** · **`OMICS-GATES-SCIENCE-CARD`** · **`AI-STACK-SCIENCE-CARD`** · **`DEID-SCIENCE-CARD`** · **`HAWTHORNE-SCIENCE-CARD`** · **`BN-VISIT-SCIENCE-CARD`** · **`PB004-SCIENCE-CARD`** · **PREP ≠ DONE:** `RITUAL-DONE-vs-PREP.md`  
...
- **Renewed:** 2026-09-16 (lần 108) · `sub_b0e15451-…` · tip → **PB004-SCIENCE-CARD** + NatMed priority if STREAK&lt;3
