# Y tế số VN × Precure — cầu nối (không partnership) · refresh v0.1b

**Mã:** YTSO-PRECURE-v0.1b · **Ngày:** 2026-09-16  
**Goal:** ACTIVE · STREAK thật vẫn **2 DONE** · EQ bank **CLOSED** · densify ≠ DONE  
**STREAK&lt;3?** Path STREAK3 trước · **`STREAK3-PACK`** · **`STREAK3-EQ`** · NatMed → tick **19/09** · dừng OPENER/stack  
**STREAK≥3?** **`AFTER-STREAK3-OPENER`** → 1×EQ sibling → **`DAILY-STACK`** · bridges #0–14  
**Không:** agent tick DONE · UpdateGoal complete trên PREP/densify · invent EQ mới · biospecimen trước G1–G2 · L3 CLOSED · partnership thương mại  
...
**Hub:** `ML-OMICS-PITFALLS` (refresh v0.1b) · tip tiếp `TRANSLATION` (`SA03-BIOFILM-TRANSLATION`) · Drive keep `1Vjchf1i…`  
...
- densify ≠ DONE · PREP≠DONE · EQ bank CLOSED.
...
- [ ] Checklist L1/L2: `AI-LONGITUDINAL-STACK` (refresh v0.1b) · `PB-009-AI-BEFORE-OMICS`  
- [ ] Nếu MISS ritual: `MISS-RESCUE-EARLY-SIGNAL-BRIDGE` (#14)

### Checklist tuần (15′) — digital health theo ba trụ

**Thẻ 1 trang:** `worksheets/YTESO-EARLY-SIGNAL-SCIENCE-CARD-v0.1.md` · **`YTESO-EQ-SCIENCE-CARD`**
...
| **AI** | Export de-ID → QC trước model? Leakage? L3? | deny/allow · `MISSINGNESS-5MIN` · `SYNTH-5MIN` · verify · `LEAKAGE-CROSS-SA-ATLAS` · `L1L2L3-DAILY-GATE-CARD` · L3 CLOSED · `ML-OMICS-PITFALLS` |
...
| Exploratory AI | SAP ES M0–M3 · **`ML-OMICS-PITFALLS`** (refresh v0.1b) · `LEAKAGE-CROSS-SA-ATLAS` |
| Omics | G2-READINESS — **CLOSED** mặc định · `MULTI-OMICS-GATES` (refresh v0.1b) |
| Ritual Tier 2 | `worksheets/DESIGN-YTESO-AI-RITUAL-CARD-v0.1.md` · bridge `DESIGN-YTESO-EARLY-SIGNAL-BRIDGE` (#3) |
...
- `guides/AI-LONGITUDINAL-STACK-v0.1.md` · `guides/ML-OMICS-PITFALLS-v0.1.md` · `equations/EQ-SA01|02|05-…`  
- **5′ drill:** `worksheets/YTESO-5MIN-MICRO-DRILL-v0.1.md` · tip tiếp `SA03-BIOFILM-TRANSLATION-v0.1.md`  
- Drive keep `1Vjchf1i…` · PREP≠DONE · densify≠DONE  
