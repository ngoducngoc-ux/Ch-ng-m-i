...
| **T3** |Bridge #12 + **L1L2L3 gate** | PEA / L1→L2 trước L3 · `L1L2L3-DAILY-GATE-CARD` · `PEA-5MIN` / `PB009-5MIN` / **`G2-5MIN`** |
| **T4** | `EQ-SA02` | leakage M1 · `VAS-SCALE-HARMONIZE-SA02` · **`VAS-5MIN`** · `LEAKAGE-5MIN` / `SYNTH-5MIN` · không gộp Y |
