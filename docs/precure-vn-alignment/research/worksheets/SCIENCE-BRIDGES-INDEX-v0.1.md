...
|---|--------|--------|----------|
| 0 | `EARLY-SIGNAL-BRIDGE-ZHOU-NATMED-SA01` | 02–03 | \(t'\ll t^*\) + sự kiện + actionable≠Dx |
...
| 14 | `MISS-RESCUE-EARLY-SIGNAL-BRIDGE` | khi MISS | A/B/C/D rescue · STREAK3 trước rotation · Goal ACTIVE |
...
**Tuỳ chọn +10–15′:** `study-sheets/STUDY-SHEET-MULTI-OMICS-ES-DRILL-v0.1.md` · EQ rotation T2=`EQ-SA01` · T4=`EQ-SA02` · T6=`EQ-SA05` · atlas `LEAKAGE-CROSS-SA-ATLAS` · `ALERT-CROSS-SA-ATLAS`.
