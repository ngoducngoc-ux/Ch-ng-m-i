...
| Trạng thái | Giữ | Bỏ |
|------------|-----|-----|
| **STREAK&lt;3** | 5MIN gate · NOW · FILL-AID · NatMed · tick 19/09 | EQ Drill 10′ · AUROC · PITFALLS×EQ |
| **Vừa ≥3** | AFTER-OPENER · EQ-M0M3 / EQ02 / EQ05 (1 sibling) | Mở hết ladder 1 ngày |
| **Mọi lúc** | \(Z\) trước \(X\) · M4 CLOSED | Agent tick · đóng Goal |
...
```text
PREP≠DONE skim? ________
EQ ladder mở hôm nay? CHƯA nếu STREAK<3
Sau tick ≥3 → opener rồi 1×EQ sibling? ________
Đóng Goal vì STREAK3×EQ? KHÔNG
```
...
`STREAK3-EQ-5MIN-MICRO-DRILL` · `STREAK3-5MIN-SCIENCE-CARD` · `STREAK3-NOW-SCIENCE-CARD` · `STREAK3-FILL-AID-SCIENCE-CARD` · `EQ-SCIENCE-CARD` · `EQ-SIBLING-MAP` · `EQ-M0M3-5MIN` · `AFTER-STREAK3-OPENER-1PAGE` · `SCIENCE-CARDS-INDEX` · `STREAK_TRACKER`
