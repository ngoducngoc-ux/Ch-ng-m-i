...
| Hạng mục ISO | Vai trò SA-04 | Giữ hôm nay | Bỏ |
|--------------|---------------|-------------|-----|
| **Cytotoxicity** | Cổng tế bào | Ôn + tra cứu phiên bản | Pass vì đã drill |
| **Sensitization** | Cổng dị ứng | Theo intended contact | Bỏ qua nếu chưa có SKU |
| **Irritation** | Cổng kích ứng | Ưu tiên surface contact | Claim đã classify |
| **Systemic toxicity** | Theo contact sâu | N/A hoặc ghi rõ | Mặc định mọi swab |
| **SA-04** | Cổng tiền lâm sàng | Không = RCT lâm sàng | Coi SA-04 = SA-01/02/05 |

## Phương trình PB-006

```text
ISO 10993 cổng (cytotox/sensitize/irritate ± systemic)
  ≥  trước  omics/diagnostics người gắn sản phẩm
SA-04 = cổng  ≠  RCT lâm sàng
Checklist nháp / PB-006 drill  ≠  ISO pass  ≠  mở G2/BIO
```
...
| Thẻ / atlas | Việc |
|-------------|------|
| **thẻ này** / EH-SA04-gates | Khung ISO cổng SA-04 · PB-006 |
| `ISO-SWAB-SCIENCE-CARD` | G5 SKU swab · irritation/cytotox |
...
`problem-bank` PB-006 · `EH-SA04-gates` · `PB006-5MIN` · `PB006-EQ-5MIN` · `ISO-SWAB-SCIENCE-CARD` · `G2-SCIENCE-CARD` · `OMICS-GATES-SCIENCE-CARD` · `TT43-SCIENCE-CARD` · `SPIRIT-G1-SCIENCE-CARD` · `SCIENCE-CARDS-INDEX` · `DAILY-STACK-AFTER-STREAK3`
