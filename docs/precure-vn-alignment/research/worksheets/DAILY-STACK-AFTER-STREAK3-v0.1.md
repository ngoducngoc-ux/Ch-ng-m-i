...
| **T4** | #2 Endpoints | `EQ-SA02` Drill 10′ · **`EQ-5MIN`** / **`EQ02-M0M3-5MIN`** / **`PB007-EQ-5MIN`** / **`PB007-5MIN`** / **`PB002-5MIN`** / **`CROSS-EQ-5MIN`** / **`CROSS-SA-5MIN`** | `VAS-SCALE-HARMONIZE-SA02` · **`VAS-5MIN`** / `LEAKAGE-5MIN` / **`VAS-LEAK-5MIN`** / **`PITFALLS-5MIN`** / `ALERT-5MIN` / **`ALERT-HAWTHORNE-5MIN`** / **`SYNTH-5MIN`** / **`TRIPOD-SYNTH-5MIN`** | **`SHIFT-5MIN`** SA-02 |
