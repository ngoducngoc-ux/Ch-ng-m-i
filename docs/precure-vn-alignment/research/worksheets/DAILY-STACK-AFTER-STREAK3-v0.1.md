...
| **T5** | #3 DESIGN-YTESO | — | `TRIPOD-5MIN` **hoặc** `DEID-5MIN` / **`DEID-MISS-5MIN`** **hoặc** `MISSINGNESS-5MIN` **hoặc** `SYNTH-5MIN` **hoặc** **`PITFALLS-5MIN`** **hoặc** `SPIRIT-5MIN` / **`SPIRIT-EQ-5MIN`** / **`SPIRIT-G1-5MIN`** / **`ICF-NEST-5MIN`** / **`AMENDMENT-ES-5MIN`** / **`AMENDMENT-EQ-5MIN`** / **`SAP-ES-5MIN`** / **`SAP-EQ-5MIN`** / **`TT43-AMEND-5MIN`** / **`CONSORT-SPIRIT-5MIN`** / **`CONSORT-EQ-5MIN`** / **`TRIPOD-SYNTH-5MIN`** / **`TRIPOD-EQ-5MIN`** **hoặc** `CONSORT-5MIN` **hoặc** `TT43-5MIN` **hoặc** `PB004-5MIN` **hoặc** `PB005-5MIN` **hoặc** **`TRANSLATION-5MIN`** **hoặc** `PB006-5MIN` / **`ISO-SWAB-5MIN`** **hoặc** `PB009-5MIN` **hoặc** `G2-5MIN` / **`INTERIM-G2-5MIN`** / **`OMICS-IF-5MIN`** **hoặc** **`OMICS-GATES-5MIN`** **hoặc** **`AI-STACK-5MIN`** **hoặc** **`YTESO-5MIN`** · y-te-so 1 ô | **`SHIFT-5MIN`** y tế số / AI |
