...
| **T3** | #1 PEA | **`L1L2L3-5MIN`** · gate card · **`AI-STACK-5MIN`** | `PEA-5MIN` / **`PREANALYTIC-5MIN`** / **`PEA-PANEL-5MIN`** / **`INTERIM-G2-5MIN`** / **`OMICS-IF-5MIN`** / **`PB009-5MIN`** / **`G2-5MIN`** / **`OMICS-GATES-5MIN`** / **`PB007-5MIN`** / **`SHIFT-PB007-5MIN`** (L3 CLOSED) | **`SHIFT-5MIN`** · 1 câu PB-009 |
...
| **T6** | #4 hoặc #8 | `EQ-SA05` Drill 10′ · **`EQ-5MIN`** / **`EQ05-M0M3-5MIN`** / **`PB007-EQ-5MIN`** / **`PB007-5MIN`** / **`SHIFT-PB007-5MIN`** / **`PB003-5MIN`** / **`CROSS-EQ-5MIN`** / **`CROSS-SA-5MIN`** / **`LEAK-CROSS-5MIN`** | `PUSH-SA05-COMPONENTS` · **`PUSH-5MIN`** / `ALERT-5MIN` / **`PUSH-ALERT-5MIN`** / **`ALERT-HAWTHORNE-5MIN`** / **`L1L2L3-5MIN`** | **`SHIFT-5MIN`** SA-05 |
