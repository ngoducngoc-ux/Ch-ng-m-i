...
| **T3** | #1 PEA | **`L1L2L3-5MIN`** · gate card · **`AI-STACK-5MIN`** | `PEA-5MIN` / **`PREANALYTIC-5MIN`** / **`PEA-PANEL-5MIN`** / **`INTERIM-G2-5MIN`** / **`PB009-5MIN`** / **`G2-5MIN`** / **`OMICS-GATES-5MIN`** / **`PB007-5MIN`** (L3 CLOSED) | **`SHIFT-5MIN`** · 1 câu PB-009 |
