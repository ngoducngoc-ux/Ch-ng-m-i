...
| **T5** | #3 DESIGN-YTESO | — | `TRIPOD-5MIN` **hoặc** `DEID-5MIN` **hoặc** `MISSINGNESS-5MIN` **hoặc** `SYNTH-5MIN` **hoặc** `SPIRIT-5MIN` **hoặc** `CONSORT-5MIN` **hoặc** `TT43-5MIN` **hoặc** `PB004-5MIN` **hoặc** `PB006-5MIN` **hoặc** `PB009-5MIN` **hoặc** `G2-5MIN` · y-te-so 1 ô | **`SHIFT-5MIN`** y tế số / AI |
...
| **CN** | #7/#10/#11 hoặc **#13** | — | PB lens 1 hàng · **`MEDIA-5MIN`** / **`PB008-5MIN`** / **`PB007-5MIN`** / **`PB001-5MIN`** / **`PB002-5MIN`** / **`PB003-5MIN`** / **`PB006-5MIN`** | **`SHIFT-5MIN`** Press |
