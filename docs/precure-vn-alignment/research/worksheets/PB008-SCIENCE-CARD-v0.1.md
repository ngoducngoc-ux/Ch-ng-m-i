...
| Hỏi | Giữ hôm nay | Bỏ |
|-----|-------------|-----|
| eCRF hành vi do nghiên cứu? | VISIT_COMPLIANCE · DRESSING_ADH · STUDY_BEHAV_CHANGE (nháp) | Coi AE sản phẩm = participation |
| Intensity follow-up? | Số visit / đi muộn làm covariate exploratory | Giải thích primary bằng visit dày |
| ALERT A1–A4 lệch ES? | Ghi sensitivity SAP ES | ALERT = hiệu quả điều trị / Dx |
| “Đã loại Hawthorne”? | **KHÔNG** bằng 1 biến | Đóng PB-008 / Goal vì đã điền drill |

## Một câu PB-008

```text
Profiling + ALERT feedback → có thể đổi Z(t') / adherence / VAS
≠ hiệu quả sản phẩm · ≠ tín hiệu sớm omics · ≠ causal trên Y(t*)
covariate / SAP sensitivity exploratory · primary giữ nguyên
```
...
| Thẻ / atlas | Việc |
|-------------|------|
| **thẻ này** / PB-008 bank | Câu hỏi lệch \(Z\) · biến · SAP |
| `HAWTHORNE-SCIENCE-CARD` | Cơ chế bias × bảo vệ primary SA |
...
`problem-bank` PB-008 · `PB-008-participation-effects` · `PB008-5MIN` · `PB008-EQ-5MIN` · `HAWTHORNE-SCIENCE-CARD` · `HAWTHORNE-5MIN` · `ALERT-HAWTHORNE-5MIN` · `NATMED-STREAK3-SCIENCE-CARD` · `ALERT-SCIENCE-CARD` · `SAP-ES-SCIENCE-CARD` · `MEDIA-SCIENCE-CARD` · `SCIENCE-CARDS-INDEX` · `DAILY-STACK-AFTER-STREAK3` · **`STREAK3-PACK-SCIENCE-CARD`**
