...
| Ý Nat Med (abstract) | Giữ cho Smart A (phát hiện sớm–dọc–AI) | Bỏ / không suy diễn |
|----------------------|----------------------------------------|---------------------|
...
1. Cadence D0–D7 đủ dày để bắt tín hiệu trước D21 không?  
2. “Actionable” trước D21 = hội chẩn / cấy lại SOP / đánh giá AE — cái nào cần trong ALERT hôm nay?  
3. PB-008: nếu VAS tốt vì đổi lifestyle khi theo dõi, diễn giải primary thế nào?

## 15–45′ — map + tick (không bỏ khoa học)
...
**`ALERT-SCIENCE-CARD`** · `NATMED-ACTIONABLE-ALERT-MAP` · `STREAK3-NOW-1PAGE` · `STREAK3-FILL-AID` · `STUDY-SHEET-NATMED-PEA` · `EARLY-SIGNAL-BRIDGE-ZHOU-NATMED-SA01` · `PI-SESSION-SCRIPT-STREAK3` · `PI-NEXT-45MIN` · **`HAWTHORNE-SCIENCE-CARD`** · **`MEDIA-SCIENCE-CARD`** · `SCIENCE-CARDS-INDEX` · **`STREAK3-PACK-SCIENCE-CARD`** · **`PB008-SCIENCE-CARD`**
