# SHIFT — thẻ khoa học 1 trang (1 câu lệch hướng · sớm–dọc–AI) · refresh v0.1b

**Mã:** SHIFT-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn **lệch hướng nghiên cứu** Precure/Smart A: mỗi ngày neo 1 SA (hoặc y tế số/press) + 1 trụ (Sớm|Dọc|AI) → **tự viết** ≤25 từ — chứng tỏ đã ôn multi-omics/tín hiệu sớm, **không** claim Dx / đóng Goal / mở omics; densify ≠ DONE / G2.
...
| **Agent densify** | Anti-forget · hub wire | ≠ mở G2 / tick DONE |
...
1 câu CẤM hôm nay:
Cặp đã đụng (EQ/ALERT/LEAKAGE/G2/SYNTH/…): ________
Ôn SHIFT / densify  ≠  G2 / DONE
Order omics / đóng Goal vì đã viết shift / densify? KHÔNG
1 việc ≤30′ (SHIFT-5MIN / G2 / EQ / MEDIA / HAWTHORNE): ________
```
...
- Dùng shift / densify để mở G2 / tick DONE / đóng Goal  
- PHI / overclaim press  
