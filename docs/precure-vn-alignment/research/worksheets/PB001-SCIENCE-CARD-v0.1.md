# PB001 — thẻ khoa học 1 trang (SA-01 cờ đầu · early healing) · refresh v0.1b

**Mã:** PB001-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
1 việc ≤30′ (EPI/EQ/IMAGEJ/DM eCRF / PB005): ________
```
...
- Order \(X_{\text{PEA}}\) / đổi primary vì đã điền PB-001 · invent EQ  
