...
**Mở song song:** thẻ này · `ICF-NEST-SA01` · `SPIRIT-G1-5MIN` · `G2-SCIENCE-CARD` · `PB004-SCIENCE-CARD`

## Consent → giữ / bỏ

| Lớp | Vai trò | Giữ hôm nay | Bỏ |
|-----|---------|-------------|-----|
| **ICF chính** | RCT + \(Z\) dọc | Đủ chăm sóc chuẩn | Gộp omics vào 1 chữ ký |
...
| Thẻ / atlas | Việc |
|-------------|------|
| **thẻ này** / ICF-NEST | Consent tách trước mẫu |
...
`ICF-NEST-SA01` · `ICF-NEST-5MIN` · `ICF-EQ-5MIN` · `SPIRIT-G1-5MIN` · `SPIRIT-NESTED-G1-CHECKLIST` · `G2-SCIENCE-CARD` · `PB004-SCIENCE-CARD` · `TT43-5MIN` · `DEID-SCIENCE-CARD` · `OMICS-GATES-SCIENCE-CARD` · **`SPIRIT-G1-SCIENCE-CARD`** · **`AMENDMENT-ES-SCIENCE-CARD`** · `SCIENCE-CARDS-INDEX` · `DAILY-STACK-AFTER-STREAK3`
