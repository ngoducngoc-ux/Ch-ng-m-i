...
> Smart A **không** claim đã có hệ thống multi-omics phát hiện bệnh sớm như narrative thương mại Precure; chúng ta đang **RCT có cổng** (Z dọc trước, omics sau G2, AI exploratory không triển khai chẩn đoán).
...
| Kiểu claim | Precure / press (tham chiếu VDHN) | Smart A — cách nói đúng |
|------------|-------------------------------------|-------------------------|
| Phát hiện sớm | Tiềm năng cá nhân hóa | Exploratory SAP ES; N=80–120 |
| Multi-omics | Stack quy mô lớn | Gated SPEC BIO; SA-03 in-vitro riêng |
| AI | Pattern trước triệu chứng | M0–M3 trên REDCap; TRIPOD nếu publish |
| Hành động | Actionable precision health | ALERT nội bộ A/B/C — không auto-treat |
| Bằng chứng | Partnership / vision | DOI peer-review + đề cương TT43/ICH |
