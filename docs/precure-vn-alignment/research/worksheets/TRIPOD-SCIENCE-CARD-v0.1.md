# TRIPOD — thẻ khoa học 1 trang (trước claim AI · Y/predictors/validation) · refresh v0.1b

**Mã:** TRIPOD-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn **cổng báo cáo AI** Precure/Smart A: trước “AI dự báo early-signal” — khoanh **Y / predictors pre-spec / validation / limitation**; AUROC sandbox ≠ evidence BN; densify ≠ model ready.
...
| **Agent densify** | Anti-forget | Hub wire | = TRIPOD CLOSED / Dx ready |
...
Ôn TRIPOD / densify  ≠  model ready  ≠  DONE
```
...
Densify = Dx sẵn sàng? KHÔNG
1 việc ≤30′ (TRIPOD-5MIN / TRIPOD-SYNTH / LEAKAGE / ICF-NEST): ________
Đóng Goal / mở G2 vì TRIPOD ô đủ? KHÔNG
```
...
- Báo “phát hiện sớm lâm sàng” từ sandbox / densify  
- Thêm predictor sau peek AUROC  
- Mở G2 / đóng Goal / invent EQ vì đã điền đủ ô TRIPOD · densify = DONE  
