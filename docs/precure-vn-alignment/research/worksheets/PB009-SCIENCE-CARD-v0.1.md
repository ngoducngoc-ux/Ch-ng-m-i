...
| Lớp | Vai trò | Giữ hôm nay | Bỏ |
|-----|---------|-------------|-----|
| **L1** | Visit + ID + `clin_event` + \(Z\) sớm | Schema dọc · PB-004 | Abstract = “đã có dọc” |
| **L2** | de-ID QC · M0–M3 SAP · metrics **N thật** | Exploratory · TRIPOD bound | `verify.sh` PASS = L2.4 |
| **L3** | PEA / omics \(X\) | **CLOSED** đến G2+H0_mol+N thật | Order assay vì “chưa có omics AI” |
| **ALERT** | Nội bộ nghiên cứu | Gắn quyết định study | App Dx / đổi RCT |
...
verify.sh PASS ≠ L2.4 · AUROC sandbox ≠ BN · checklist ≠ order PEA
```
...
| Thẻ / atlas | Việc |
|-------------|------|
| **thẻ này** / PB-009 checklist | Đủ chưa L1/L2 · khi nào L3 |
| `AI-STACK-SCIENCE-CARD` | Pipeline stack 3 lớp |
