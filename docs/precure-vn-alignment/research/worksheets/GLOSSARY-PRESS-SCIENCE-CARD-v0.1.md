...
| Term press | Nghĩa Smart A (giữ) | Không nghĩa (bỏ · dán) |
|------------|---------------------|------------------------|
| Phát hiện sớm | \(Z(t')\) → \(Y(t^*)\) SAP ES | App Dx / trước triệu chứng marketing |
| Multi-omics | \(X\) L3 sau G2 | Điều kiện để bắt đầu ôn / order PEA |
| AI sớm | M0–M3 trên \(Z\) L1→L2 | Pattern Dx vanity / AUROC sandbox |
| Actionable | ALERT nội bộ A/B/C | Auto-treat / đổi RCT |
| Dữ liệu dọc | Visit + `clin_event` + \(Z\) | Snapshot 1 điểm = Precure |
| PREP xong | Agent scaffold | STREAK DONE / Goal complete |

## Câu dán (chọn 1 term)

```text
Term: ________
Nghĩa Smart A: ________
Không nghĩa (anti-press): ________
VDHN≠DOI kèm: xem MEDIA-BOUND · không equate press = evidence
```

## Checklist 15′

```text
Thứ: STREAK3|CN · Term press hôm nay: ________
Nghĩa Smart A (≤12 từ): ________
Không nghĩa dán log (≤12 từ): ________
Gắn MEDIA-BOUND / FILL-AID VDHN? ________
Early-signal = app Dx? KHÔNG
Multi-omics = mở L3 hôm nay? KHÔNG
PREP = STREAK DONE? KHÔNG
1 việc ≤30′ (GLOSSARY-5MIN / MEDIA-BOUND / SHIFT Press): ________
