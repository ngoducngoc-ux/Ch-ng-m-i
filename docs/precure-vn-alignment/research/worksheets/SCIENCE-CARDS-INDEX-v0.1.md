...
| Nếu | Mở **1** thẻ |
|-----|----------------|
| STREAK &lt;3 | **`STREAK3-PACK-SCIENCE-CARD`** · **`NATMED-STREAK3-SCIENCE-CARD`** + **`ALERT-SCIENCE-CARD`** + **`NATMED-ALERT-SCIENCE-CARD`** + **`HAWTHORNE-SCIENCE-CARD`** + **`ALERT-HAWTHORNE-SCIENCE-CARD`** + **`MEDIA-SCIENCE-CARD`** / **`MEDIA-BOUND-SCIENCE-CARD`** + **`STREAK3-FILL-AID`** → log **19/09** |
