# IMAGEJ — thẻ khoa học 1 trang (PCT_EPITH QA · trước AUROC) · refresh v0.1b

**Mã:** IMAGEJ-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn IMAGEJ / densify  ≠  AUROC OK  ≠  DONE
```
...
1 việc ≤30′ (IMAGEJ-QA / EPI / EQ-SA01 / PEA-PANEL): ________
...
- Order PEA / đóng Goal / mở L3 vì QA giấy · invent EQ · densify = DONE  
