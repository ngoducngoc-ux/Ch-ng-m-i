# MEDIA — thẻ khoa học 1 trang (VDHN vs DOI · ranh giới claim) · refresh v0.1b

**Mã:** MEDIA-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn **ranh giới truyền thông** Precure/Smart A: VDHN tường thuật thương mại; DOI Nat Med minh họa “actionable” **trong nghiên cứu** — Smart A map ALERT nội bộ, không claim multi-omics/Dx sẵn sàng; densify ≠ press cleared.
...
| **Agent densify** | Anti-forget | Hub wire | = press cleared / partnership |
...
Ôn MEDIA / densify  ≠  press OK  ≠  DONE
```
...
Densify = press cleared? KHÔNG
1 việc ≤30′ (MEDIA-5MIN / FILL-AID câu VDHN / SHIFT Press / PB004): ________
Đóng Goal / order omics vì press? KHÔNG
```
...
- Order omics vì “press đã nói multi-omics” · đóng Goal / invent EQ · densify = DONE  
