# MISSINGNESS — thẻ khoa học 1 trang (L2 %miss · visit window · trước AUROC) · refresh v0.1b

**Mã:** MISSINGNESS-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn **cổng chất lượng L2** Precure/Smart A: trước claim early-signal — biết **% miss theo visit** và **window** (vd. D3) đã rõ; QC demo xanh / densify ≠ missingness lâm sàng.
...
| **Agent densify** | Anti-forget | Hub wire | = L2 CLOSED / AUROC OK |

## Phương trình L2 QC

```text
N thật + %miss(visit,Z) + window rõ  ≥  trước  M0–M3 / AUROC claim
--demo PASS / densify  ≠  missingness lâm sàng
SYN / demo  ≠  BN
Ôn MISSINGNESS / densify  ≠  QC lâm sàng  ≠  DONE
```
...
Densify = N thật / L2 CLOSED? KHÔNG
1 việc ≤30′ (MISSINGNESS-5MIN / **DEID-MISS-SCIENCE-CARD** / L2 audit 1 ô / MEDIA): ________
Đóng Goal / mở G2 vì QC demo PASS? KHÔNG
```
...
- Mở G2 / đóng Goal / invent EQ vì “QC demo PASS” · densify = DONE  
