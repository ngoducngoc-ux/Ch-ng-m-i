...
|------|------|------------------------------|
| 0–15 | Bridge #0 Zhou↔NatMed↔SA-01 **hoặc** EQ-SA01 Drill 10′ | `EARLY-SIGNAL-BRIDGE-ZHOU-NATMED-SA01` · **`ZHOU-STREAK3-SCIENCE-CARD`** · `EQ-SA01` / **`EQ-M0M3-5MIN`** |
| 15–25 | Atlas 1 hàng: EPI window **hoặc** ALERT A | `EPI-SA01-EARLY-WINDOW` / **`EPI-5MIN`** · `ALERT-5MIN` / **`NATMED-ALERT-5MIN`** |
| 25–40 | 1 câu lệch hướng Smart A (sớm–dọc–AI) | **`SHIFT-5MIN`** · bank `PRECURE-SHIFT-CROSS-SA-BANK` |
...
Mở full `DAILY-STACK-AFTER-STREAK3` theo thứ ICT · T3: **`L1L2L3`** / **`PEA-WEEK1`** · T4/T6: **`ENDPOINTS`** / **`LEAKAGE`** / **`ALERT`** · T5: **`DESIGN-WEEK1`** / **`YTESO`** · T7: **`CLIN_EVENT`** · định tuyến **`SCIENCE-CARDS-INDEX`** · `EQ-SIBLING-MAP` · weekly **#13** · MISS **#14**
