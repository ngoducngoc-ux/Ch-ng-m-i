# TT43 — thẻ khoa học 1 trang (amendment hooks VN · Git ≠ duyệt) · refresh v0.1b

**Mã:** TT43-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn **luồng phê duyệt VN** Precure/Smart A: đổi early-signal / `clin_event` / omics trên REDCap = **TT43 + HĐĐĐ**, không chỉ merge Git. Ô số điều còn `[CẦN XÁC NHẬN]` thì chưa “đã duyệt”; densify ≠ duyệt.
...
| **CONSORT placement** | Báo cáo ES | Exploratory | Claim “đã duyệt” vì đã đặt ES |
| **Agent densify** | Anti-forget | Hub wire | = HĐĐĐ / TT43 pass |
...
Agent densify = HĐĐĐ pass? KHÔNG
1 việc ≤30′ (PI dán số điều / AMENDMENT-ES / SPIRIT-G1 / CONSORT): ________
Đóng Goal / order omics vì TT43 ô đủ? KHÔNG
```
...
- Coi merge Git / densify = HĐĐĐ/TT43 pass  
- Order omics / đóng Goal / agent tư vấn pháp lý thay PI · invent EQ · densify = DONE  
