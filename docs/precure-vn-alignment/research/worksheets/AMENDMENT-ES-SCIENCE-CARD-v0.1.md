# AMENDMENT-ES — thẻ khoa học 1 trang (outline ES · không đổi primary) · refresh v0.1b

**Mã:** AMENDMENT-ES-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn **outline amendment early-signal** Precure/Smart A: 5 bullet (S1 outcomes · S2 không adaptive · S3 eCRF · TT43 số điều · nested chỉ sau G1–G2). Nháp Git ≠ đã nộp; không đổi primary / không claim AUROC synthetic = BN; densify ≠ CLOSED.
...
| **Agent densify** | Anti-forget | Hub wire | = đã nộp HĐĐĐ |
...
Ôn AMENDMENT-ES / densify  ≠  đã nộp  ≠  DONE
```
...
Gửi HĐĐĐ từ PREP/densify? KHÔNG
1 việc ≤30′ (outline / TT43 / SAP §7 / SPIRIT-G1): ________
Đóng Goal / order omics vì amendment ô đủ? KHÔNG
```
...
- Coi nháp amendment / densify = CLOSED / đã duyệt  
- Order omics / đóng Goal / invent EQ vì đã drill · densify = DONE  
