...
- [ ] (Nếu còn phút) 1 vignette `CLIN_EVENT-CODING-VIGNETTES` — optional, không bắt buộc STREAK 3  
...
`PI-NEXT-45MIN.md` · `DAILY-STACK-AFTER-STREAK3` · `SCIENCE-BRIDGES-INDEX` · `RITUAL-CARDS-INDEX` · `RITUAL-DONE-vs-PREP` · `GOAL-HEALTH`
