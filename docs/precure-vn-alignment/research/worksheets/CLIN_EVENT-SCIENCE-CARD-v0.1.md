# clin_event — thẻ khoa học 1 trang (dọc L1 · Zhou analog · sớm–dọc–AI) · refresh v0.1b

**Mã:** CLIN_EVENT-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
**Neo:** L1L2L3 (refresh v0.1b) · BN-VISIT · ALERT  
**Dùng khi:** Makeup Zhou 18/09 · T7 · EQ L1 · BN-VISIT · sau STREAK≥3  
**Hub:** `L1L2L3-SCIENCE-CARD` (refresh v0.1b) · tip tiếp `ALERT-SCIENCE-CARD` · Drive keep `1Vjchf1i…`  
...
Ôn analog Zhou trên Smart A: omics nhảy khi có **sự kiện** → bắt bằng **event dọc** trên eCRF (ID–visit–time–event–\(Z\)) — **không** mã event từ \(Y(t^*)\), **không** mở omics vì đã có schema / densify.
...
| **Agent densify** | Anti-forget · hub wire | ≠ order PEA / PHI OK |
...
Ôn CLIN_EVENT / densify  ≠  L1 CLOSED  ≠  DONE
```
...
Densify = lâm sàng BN / mở omics? KHÔNG
1 việc ≤30′ (CLIN_EVENT-5MIN / BN-VISIT / ALERT / LEAKAGE): ________
Đóng Goal / order PEA vì schema đủ? KHÔNG
```
...
- PHI trong repo · event = primary label · order omics vì schema / densify  
