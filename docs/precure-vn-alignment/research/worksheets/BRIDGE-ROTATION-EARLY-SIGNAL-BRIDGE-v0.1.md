...
|------|---------------|----------|
| **Anti-forget** | 1 insight/ngày suốt 12 tháng — không “xong curriculum” | STREAK · daily 45′ |
| **Ba trụ lặp** | \(t'\ll t^*\) · \(Z\)+`clin_event` · L1→L2 trước L3 | #0–2 · #4 · #8 |
| **Y tế số + AI** | De-ID · PB-004 · TRIPOD · không PHI | #3 · #5 · #9 |
| **Governance** | G2 CLOSED · Year-1 gia hạn (PI) | #4 · #11 |

#11 = đối chiếu anniversary; **#12** = **máy chọn bridge hôm nay** để chuỗi không chết sau lần đọc đầu.
...
2. **Bỏ STREAK3** để nhảy rotation khi STREAK &lt;3.  
3. **Omics / G2** vì đã ôn #1 và #4 trong tuần.

## Ritual fill-in (mỗi ngày 15′)

```text
Thứ: T2…CN | Bridge #: __
1 insight multi-omics / ES / y tế số / AI:
1 câu gắn SA-01:
G2: CLOSED | …
Goal: ACTIVE
