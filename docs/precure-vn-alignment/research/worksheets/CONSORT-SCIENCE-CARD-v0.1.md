# CONSORT — thẻ khoa học 1 trang (ES placement · không cùng hàng primary) · refresh v0.1b

**Mã:** CONSORT-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn **đặt early-signal trên báo cáo** Precure/Smart A: SPIRIT **khai** ES trước; CONSORT **đặt** ES ở Methods/Results exploratory — không cùng hàng primary; sandbox/`verify.sh` không vào Results lâm sàng; densify ≠ “đã báo đúng”.
...
| **CONSORT-AI** | Extension AI | `[CẦN XÁC NHẬN]` nếu claim AI | Claim đã đủ vì đã drill |
| **TT43 / Git** | Phê duyệt VN | Hooks riêng | Merge Git = đã báo đúng |
...
Ôn CONSORT / densify  ≠  “đã báo ES đúng”  ≠  DONE
```
...
Merge Git = “đã báo đúng”? KHÔNG
1 việc ≤30′ (placement / SAP / TRIPOD / SPIRIT / TT43): ________
Đóng Goal / mở G2 vì CONSORT ô đủ? KHÔNG
```
...
- Claim “đã báo ES đúng” chỉ vì đã drill · densify = DONE  
- Đóng Goal / mở G2 / invent EQ vì CONSORT ô đủ  
