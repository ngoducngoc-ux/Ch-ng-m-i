# BN-VISIT — thẻ khoa học 1 trang (map StudyID→visit→Z · dọc · y tế số) · refresh v0.1b

**Mã:** BN-VISIT-SCIENCE-CARD-v0.1b · **Ngày:** 2026-09-16  
...
Ôn **map visit dọc** Precure/Smart A: StudyID → visits → \(Z\)/`clin_event` — luyện y tế số L1 trước mọi AI/omics. Không họ tên/SĐT/MRN · omics mặc định CLOSED; densify ≠ map lâm sàng BN.
...
| **Agent densify** | Anti-forget | Hub wire | = lâm sàng BN / omics sẵn |
...
SYN map / densify ≠ kết quả lâm sàng BN
Ôn BN-VISIT / densify  ≠  L1 CLOSED  ≠  DONE
```
...
Densify = lâm sàng BN? KHÔNG
1 việc ≤30′ (BN-VISIT-5MIN / CLIN_EVENT / DEID / PB004): ________
Đóng Goal / order PEA vì map đủ visit? KHÔNG
```
...
- Coi SYN map / densify = lâm sàng · order PEA vì “map đủ visit”  
