...
**Mở song song:** thẻ này · `BN-VISIT-MAP-TEMPLATE` · `CLIN_EVENT-SCIENCE-CARD` · `DEID-SCIENCE-CARD` · `YTESO-EARLY-SIGNAL-SCIENCE-CARD`
...
`BN-VISIT-MAP-TEMPLATE` · `BN-VISIT-5MIN` · `BN-VISIT-EQ-5MIN` · `CLIN-BN-5MIN` · `CLIN_EVENT-SCIENCE-CARD` · `DEID-SCIENCE-CARD` · **`PB004-SCIENCE-CARD`** · `PB004-5MIN` · `YTESO-EARLY-SIGNAL-SCIENCE-CARD` · `AI-STACK-SCIENCE-CARD` · `SCIENCE-CARDS-INDEX` · `DAILY-STACK-AFTER-STREAK3`
