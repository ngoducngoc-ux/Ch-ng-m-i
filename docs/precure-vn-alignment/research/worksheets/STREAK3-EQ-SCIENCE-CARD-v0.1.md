...
| Khối | Giữ | Bỏ |
|------|-----|-----|
| **STREAK&lt;3** | PACK · NOW · FILL-AID · NatMed · tick 19/09 | EQ Drill 10′ · AUROC · DAILY-STACK full |
| **EQ ladder** | Chỉ **sau** STREAK≥3 · 1 sibling/ngày | Nhảy T2/T4/T6 ladder khi &lt;3 |
| **Progress** | **PI** tick DONE trên tracker | Agent / CI / Drive densify = STREAK |
| **Vừa ≥3** | OPENER → EQ-SIBLING (1) → BRIDGES → DAILY-STACK | Mở hết ladder 1 ngày |
| **Omics / L3** | **CLOSED** | Order vì densify / PREP đủ |
| **Order / Goal** | KHÔNG từ densify | UpdateGoal complete trên PREP |

## Phương trình ranh giới

```text
STREAK thật = ritual DONE (PI)
  +  EQ ladder M0–M3 chỉ SAU STREAK≥3
≠  scaffold densify = progress
≠  mở EQ/AUROC khi STREAK<3
≠  đóng Goal trên PREP
Ôn STREAK3×EQ  ≠  UpdateGoal
```
