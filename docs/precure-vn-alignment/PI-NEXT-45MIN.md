...
**Sau Ngày 03 (khi STREAK ≥3):** bridge #12 · **EQ** · **leakage/ALERT/clin_event atlas** · weekly **#13** · MISS **#14** · drill  

## Hub ritual cards

`RITUAL-CARDS-INDEX` · **`SCIENCE-BRIDGES-INDEX`** · **drill + EQ** · **`LEAKAGE`/`ALERT`/`CLIN_EVENT` atlas** · **rotation #12** · Tier 0 · Q3 · PB-009
