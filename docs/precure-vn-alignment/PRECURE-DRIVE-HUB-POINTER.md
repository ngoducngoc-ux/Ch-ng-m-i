...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `e1bc67a`
...
**Cập nhật pointer:** 2026-09-16 (RITUAL-HANDOFF-INDEX refresh · PI-ACTIONS-NOW · SCIENCE-CARDS-INDEX · Drive `1Vjchf1i…` · tip `e1bc67a`)
