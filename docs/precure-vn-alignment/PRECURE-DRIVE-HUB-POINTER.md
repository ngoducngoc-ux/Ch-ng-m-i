...
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **CLIN-BN-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (IMAGEJ-EPI refresh v0.1b · PUSH-ALERT · EQ05 · Drive `1Vjchf1i…` · tip `3fa9f8e`)
