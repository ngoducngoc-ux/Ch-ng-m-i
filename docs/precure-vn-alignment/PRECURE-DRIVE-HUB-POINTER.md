...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `4a53dc0`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **MEDIA-SHIFT-EQ-SCIENCE-CARD**  
...
| **CONSORT-SPIRIT-EQ thẻ khoa học (CONSORT-SPIRIT×EQ · khai+đặt ES × ladder · ≠ primary · refresh v0.1b)** | `research/worksheets/CONSORT-SPIRIT-EQ-SCIENCE-CARD-v0.1.md` |
...
**Cập nhật pointer:** 2026-09-16 (CONSORT-SPIRIT-EQ refresh v0.1b · LEAK-CROSS-EQ · PITFALLS-EQ · Drive `1Vjchf1i…` · tip `sub_40ef721d-7c9e-4868-a54d-f9153c6df27b`)
