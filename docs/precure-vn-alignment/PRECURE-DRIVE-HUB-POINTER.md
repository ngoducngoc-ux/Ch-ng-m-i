...
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **IMAGEJ-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (INTERIM-G2 refresh v0.1b · OMICS-IF · EPI · Drive `1Vjchf1i…` · tip `86f5b9c`)
