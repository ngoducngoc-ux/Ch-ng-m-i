...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `b61379c`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **NATMED-ALERT-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (ALERT-CROSS refresh v0.1b · LEAK-CROSS · ALERT-HAWTHORNE · Drive `1Vjchf1i…` · tip `b61379c`)
