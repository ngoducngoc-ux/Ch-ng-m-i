...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `ec091b5`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **OMICS-IF-EQ-SCIENCE-CARD**  
...
| **G2-EQ thẻ khoa học (G2×EQ · readiness · trước order)** | `research/worksheets/G2-EQ-SCIENCE-CARD-v0.1.md` |
...
**Cập nhật pointer:** 2026-09-16 (INTERIM-G2-EQ refresh v0.1b · PEA-PANEL-EQ · PREANALYTIC-EQ · Drive `1Vjchf1i…` · tip `sub_842eed8e-8236-4b68-b2ee-35c079eed19c`)
