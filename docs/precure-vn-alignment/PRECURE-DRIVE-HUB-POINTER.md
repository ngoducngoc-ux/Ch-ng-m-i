...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `6f83741`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **LEAKAGE**  
...
**Cập nhật pointer:** 2026-09-16 (CROSS-SA refresh v0.1b · GLOSSARY · TRANSLATION · Drive `1Vjchf1i…` · tip `6f83741`)
