...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `5d6ff8e`
...
**Cập nhật pointer:** 2026-09-16 (PUSH-ALERT/ALERT-HAWTHORNE/IMAGEJ-EPI-EQ · Drive `1Vjchf1i…` · timer `sub_PLACEHOLDER…` · SHA TBD)
