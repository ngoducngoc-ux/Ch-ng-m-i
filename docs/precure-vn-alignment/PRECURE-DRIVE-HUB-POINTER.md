...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `823faee`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **PB002-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (PB003 refresh v0.1b · PB007 · PB009 · Drive `1Vjchf1i…` · tip `823faee`)
