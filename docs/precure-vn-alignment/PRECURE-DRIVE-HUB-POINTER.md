...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `467b5bb`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **EQ-SIBLING-MAP**  
...
**Cập nhật pointer:** 2026-09-16 (AFTER-STREAK3-OPENER refresh v0.1b · STREAK3-EQ · STREAK3-PACK · Drive `1Vjchf1i…` · tip `467b5bb`)
