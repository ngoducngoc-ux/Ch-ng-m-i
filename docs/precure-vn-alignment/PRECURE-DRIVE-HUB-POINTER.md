...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `a98c8e7`
...
**Cập nhật pointer:** 2026-09-16 (INTERIM-G2-EQ-5MIN · Drive `1Vjchf1i…` · timer `sub_bb702bc8…` · `a98c8e7`)
