...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `f6e7507`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **GLOSSARY**  
...
**Cập nhật pointer:** 2026-09-16 (TRANSLATION refresh v0.1b · YTESO · ML-OMICS-PITFALLS · Drive `1Vjchf1i…` · tip `f6e7507`)
