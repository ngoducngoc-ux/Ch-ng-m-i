...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `b0f32bd`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **CONSORT-SPIRIT-EQ-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (LEAK-CROSS-EQ refresh v0.1b · PITFALLS-EQ · TRIPOD-SYNTH-EQ · Drive `1Vjchf1i…` · tip `sub_3c806a03-d465-4679-bc57-f70a2289456d`)
