...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `7af6dab`
...
**Cập nhật pointer:** 2026-09-16 (BN-VISIT-EQ-5MIN · Drive `1Vjchf1i…` · timer `sub_PLACEHOLDER…` · SHA TBD)
