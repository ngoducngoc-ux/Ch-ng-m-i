...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `f9a698a`
...
**Cập nhật pointer:** 2026-09-16 (SCIENCE-CARDS-INDEX · PEA-WEEK1-SCIENCE-CARD · Drive `1Vjchf1i…` · timer `sub_648c22e2…` · `f9a698a`)
