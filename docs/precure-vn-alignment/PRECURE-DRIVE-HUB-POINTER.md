...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `0ef5bf1`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **PI-SESSION-SCRIPT-STREAK3-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (STREAK3-EQ-5MIN refresh v0.1b · STREAK3-5MIN · FILL-AID-SC · Drive `1Vjchf1i…` · tip PENDING)
