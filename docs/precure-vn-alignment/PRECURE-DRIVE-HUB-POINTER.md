...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `4def6df`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **ZHOU-STREAK3-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (YTESO refresh v0.1b · PEA · DESIGN · Drive `1Vjchf1i…` · tip `4def6df`)
