...
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **OMICS-IF-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (EPI refresh v0.1b · GLOSSARY · CROSS-SA · Drive `1Vjchf1i…` · tip PENDING)
