...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `a4e66cd`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **YTESO**  
...
**Cập nhật pointer:** 2026-09-16 (ML-OMICS-PITFALLS refresh v0.1b · MULTI-OMICS-GATES · AI-STACK · Drive `1Vjchf1i…` · tip `a4e66cd`)
