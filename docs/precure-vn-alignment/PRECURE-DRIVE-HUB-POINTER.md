...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `f1b43dc`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **GLOSSARY-EQ-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (CROSS-EQ refresh v0.1b · IMAGEJ-EQ · LEAKAGE-EQ · Drive `1Vjchf1i…` · tip `sub_6bdc9a40-9728-4c88-9244-77fe0899d962`)
