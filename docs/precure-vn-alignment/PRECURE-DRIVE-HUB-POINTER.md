...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `5b4c61d`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **STREAK3-5MIN-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (STREAK3-FILL-AID-SC refresh v0.1b · STREAK3-NOW · DAILY-STACK · Drive `1Vjchf1i…` · tip `5b4c61d`)
