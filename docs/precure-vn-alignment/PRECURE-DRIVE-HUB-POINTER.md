...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `24432bf`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **CLIN_EVENT**  
...
**Cập nhật pointer:** 2026-09-16 (ALERT refresh v0.1b · LEAKAGE · CROSS-SA · Drive `1Vjchf1i…` · tip PENDING)
