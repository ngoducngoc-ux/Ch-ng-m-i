...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `d7cb250`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **SHIFT**  
...
**Cập nhật pointer:** 2026-09-16 (CLIN_EVENT refresh v0.1b · ALERT · LEAKAGE · Drive `1Vjchf1i…` · tip `d7cb250`)
