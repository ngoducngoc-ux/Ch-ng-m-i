...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `ccdbb0e`  
...
**Cập nhật pointer:** 2026-09-16 (INTERIM-G2 refresh v0.1b · OMICS-IF · EPI · Drive `1Vjchf1i…` · tip PENDING)
