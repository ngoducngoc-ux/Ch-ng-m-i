...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `0d69ab8`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **ISO-SWAB-EQ-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (DEID-EQ refresh v0.1b · SPIRIT-G1-EQ · CONSORT-EQ · Drive `1Vjchf1i…` · tip `sub_58655370-6ebf-4dec-b497-5c4714047b07`)
