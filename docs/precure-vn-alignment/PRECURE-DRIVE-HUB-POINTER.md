...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `ba505b4`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **CURRICULUM-MONTHS-4-12-OUTLINE**  
...
**Cập nhật pointer:** 2026-09-16 (CURRICULUM-ROADMAP refresh v0.1b · READING-INDEX · STUDY-SHEET · Drive `1Vjchf1i…` · tip `ba505b4`)
