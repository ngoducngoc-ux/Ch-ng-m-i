...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `1efb558`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **SAP-EQ-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (ICF-EQ refresh v0.1b · TT43-AMEND · L1L2L3-SHIFT · Drive `1Vjchf1i…` · tip `sub_df74be72-647d-4f79-a244-db44988c700c`)
