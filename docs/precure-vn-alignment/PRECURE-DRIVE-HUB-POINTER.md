...
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **MEDIA-SHIFT-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (NATMED-ALERT refresh v0.1b · ALERT-CROSS · LEAK-CROSS · Drive `1Vjchf1i…` · tip PENDING)
