...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `0a0f7f7`
...
**Cập nhật pointer:** 2026-09-16 (PB007-EQ-5MIN · Drive `13Va6AK4…` · timer `sub_e57fdb88…` · `0a0f7f7` · Drive MCP deferred)
