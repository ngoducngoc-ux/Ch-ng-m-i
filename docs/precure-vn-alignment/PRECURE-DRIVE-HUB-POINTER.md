...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `80bb3ae`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **YTESO-EQ-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (CLIN-BN-EQ refresh v0.1b · AI-STACK-EQ · L1L2L3-EQ · Drive `1Vjchf1i…` · tip `sub_4eca8a5b-acc6-4c88-8996-3479065a574c`)
