...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `4b1a6c2`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **YTESO-EARLY-SIGNAL-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (PEA refresh v0.1b · DESIGN · ENDPOINTS · Drive `1Vjchf1i…` · tip `4b1a6c2`)
