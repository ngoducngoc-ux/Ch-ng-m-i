...
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **WORKSHEET-INDEX**  
...
**Cập nhật pointer:** 2026-09-16 (RITUAL-CARDS-INDEX refresh v0.1b · SCIENCE-CARDS-INDEX · POINTER · Drive `1Vjchf1i…` · tip `20d1d9e`)
