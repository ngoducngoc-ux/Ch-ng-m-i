...
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **ENDPOINTS-WEEK1-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (LEAKAGE refresh v0.1b · NATMED · ALERT · Drive `1Vjchf1i…` · tip `8a88eee`)
