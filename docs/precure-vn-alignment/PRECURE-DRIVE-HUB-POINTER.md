...
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **MEDIA-BOUND-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (RITUAL-DONE-SC refresh v0.1b · PI-SESSION-SC · STREAK3-EQ-5MIN · Drive `1Vjchf1i…` · tip PENDING)
