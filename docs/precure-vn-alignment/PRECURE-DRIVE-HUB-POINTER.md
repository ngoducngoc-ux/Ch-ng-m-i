...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `4304f42`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **SAP-ES-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (ISO-SWAB refresh v0.1b · PREANALYTIC · PITFALLS · Drive `1Vjchf1i…` · tip `4304f42`)
