...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `1cbe5af`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **TRANSLATION**  
...
**Cập nhật pointer:** 2026-09-16 (YTESO refresh v0.1b · ML-OMICS-PITFALLS · OMICS-GATES · Drive `1Vjchf1i…` · tip `1cbe5af`)
