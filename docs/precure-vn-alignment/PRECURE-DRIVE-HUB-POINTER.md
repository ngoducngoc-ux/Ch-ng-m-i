...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `8a33837`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **IMAGEJ-EPI-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (PUSH-ALERT refresh v0.1b · EQ05 · EQ02 · Drive `1Vjchf1i…` · tip PENDING)
