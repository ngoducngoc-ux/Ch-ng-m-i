...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `9120efa`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **RITUAL-CARDS-INDEX**  
...
**Cập nhật pointer:** 2026-09-16 (SCIENCE-CARDS-INDEX refresh v0.1b · PRECURE-DRIVE-HUB-POINTER · INDEX · Drive `1Vjchf1i…` · tip `9120efa`)
