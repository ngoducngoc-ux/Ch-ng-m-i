...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `16b9d60`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **PEA-PANEL-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (IMAGEJ refresh v0.1b · INTERIM-G2 · OMICS-IF · Drive `1Vjchf1i…` · tip `16b9d60`)
