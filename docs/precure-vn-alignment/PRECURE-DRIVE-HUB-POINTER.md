...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `a89c6df`  
...
**Cập nhật pointer:** 2026-09-16 (ICF-NEST refresh v0.1b · TRIPOD · SPIRIT-G1 · Drive `1Vjchf1i…` · tip `a89c6df`)
