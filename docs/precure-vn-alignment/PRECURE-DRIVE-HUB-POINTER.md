...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `bcdba89`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **L1L2L3-SHIFT-EQ-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (MEDIA-SHIFT-EQ refresh v0.1b · CONSORT-SPIRIT-EQ · LEAK-CROSS-EQ · Drive `1Vjchf1i…` · tip `sub_b30b18d7-7c2b-4f4c-940f-c13d21adbad5`)
