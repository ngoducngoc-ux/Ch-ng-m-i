...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `82d3d91`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **DEID-MISS-EQ-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (VAS-LEAK-EQ refresh v0.1b · IMAGEJ-EPI-EQ · PUSH-ALERT-EQ · Drive `1Vjchf1i…` · tip `sub_a4b571d2-5bcb-4c28-8d8a-cfd226f631b3`)
