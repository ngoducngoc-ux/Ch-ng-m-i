...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `c545c4f`  
...
**Cập nhật pointer:** 2026-09-16 (ALERT refresh v0.1b · LEAKAGE · CROSS-SA · Drive `1Vjchf1i…` · tip `c545c4f`)
