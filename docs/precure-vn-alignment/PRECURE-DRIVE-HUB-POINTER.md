...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `0cb03be`
...
**Cập nhật pointer:** 2026-09-16 (EQ02-M0M3-5MIN · Drive `13Va6AK4…` · timer `sub_PLACEHOLDER…` · SHA TBD · Drive MCP deferred)
