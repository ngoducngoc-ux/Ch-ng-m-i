...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `6c5771c`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **VAS-LEAK-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (CLIN-BN refresh v0.1b · IMAGEJ-EPI · PUSH-ALERT · Drive `1Vjchf1i…` · tip `6c5771c`)
