...
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **PEA-WEEK1-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (DESIGN refresh v0.1b · ENDPOINTS · LEAKAGE · Drive `1Vjchf1i…` · tip `9156f28`)
