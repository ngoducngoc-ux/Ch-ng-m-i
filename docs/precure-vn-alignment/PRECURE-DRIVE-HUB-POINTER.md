...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `d2d971f`
...
**Cập nhật pointer:** 2026-09-16 (EQ05-M0M3-5MIN · Drive `13Va6AK4…` · timer `sub_7b324089…` · `d2d971f` · Drive MCP deferred)
