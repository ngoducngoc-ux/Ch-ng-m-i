...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `ccb0e1b`
...
**Cập nhật pointer:** 2026-09-16 (PB001-SCIENCE-CARD · SCIENCE-CARDS-INDEX · Drive `1Vjchf1i…` · timer `sub_cfd2ba4c…` · `ccb0e1b`)
