...
**Git source of truth:** `github.com/ngoducngoc-ux/Ch-ng-m-i` · branch `cursor/precure-vn-alignment-729d` · PR #2 · commit `fb1fc0d`  
**Timer:** `precure-daily-check` cron `30 0 * * *` · tip → **DESIGN-WEEK1-SCIENCE-CARD**  
...
**Cập nhật pointer:** 2026-09-16 (ENDPOINTS refresh v0.1b · LEAKAGE · NATMED · Drive `1Vjchf1i…` · tip `fb1fc0d`)
