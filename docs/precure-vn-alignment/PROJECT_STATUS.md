...
**Cập nhật:** 2026-09-16 (STREAK3-EQ-5MIN refresh · STREAK3-5MIN · timer · Drive OK)
...
|------------|------------|------------|
| Email handoff | SENT | Outlook → ngoducngoc@gmail.com 2026-09-16 ×356 (STREAK3-EQ-5MIN · STREAK3-5MIN · NatMed) |
...
| daily-protocol | OK | `rituals/daily-protocol.md` · refresh v0.1b · STREAK3 gate · OPENER→EQ→DAILY · path fix |
| weekly-review | OK | `rituals/weekly-review.md` · refresh v0.1b · STREAK3 trước #13 · OPENER→EQ→#13 |
| WEEKLY-PACK-INDEX | OK | `rituals/WEEKLY-PACK-INDEX.md` · refresh v0.1b · STREAK3 trước pack CN · #13/#14 |
| quarterly-review | OK | `rituals/quarterly-review.md` · refresh v0.1b · STREAK3 trước · OPENER→EQ→pack quý |
...
| INDEX | OK | `INDEX.md` · refresh v0.1b · STREAK3 gate · OPENER→EQ→bridges #0–14 |
| PRECURE-DRIVE-HUB-POINTER | OK | `PRECURE-DRIVE-HUB-POINTER.md` · refresh v0.1b · STREAK3 gate · Drive keep · tip→SCIENCE-CARDS-INDEX |
| SCIENCE-CARDS-INDEX | OK | `research/worksheets/SCIENCE-CARDS-INDEX-v0.1.md` · refresh v0.1b · STREAK3 gate · OPENER→EQ · tip→RITUAL-CARDS-INDEX |
...
| GLOSSARY (early-signal) | OK | `research/worksheets/EARLY-SIGNAL-GLOSSARY-v0.1.md` · refresh v0.1b · tip→CROSS-SA |
| CROSS-SA early-signal map | OK | `research/worksheets/CROSS-SA-EARLY-SIGNAL-MAP-v0.1.md` · refresh v0.1b · tip→LEAKAGE |
...
| PB008 science card | OK | `research/worksheets/PB008-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PB009-SCIENCE-CARD |
| PB009 science card | OK | `research/worksheets/PB009-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PB007-SCIENCE-CARD |
| PB007 science card | OK | `research/worksheets/PB007-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PB003-SCIENCE-CARD |
| PB003 science card | OK | `research/worksheets/PB003-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PB002-SCIENCE-CARD |
...
| SPIRIT science card | OK | `research/worksheets/SPIRIT-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→TRANSLATION-SCIENCE-CARD |
| TRANSLATION science card | OK | `research/worksheets/TRANSLATION-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→CROSS-SA-SCIENCE-CARD |
| CROSS-SA science card | OK | `research/worksheets/CROSS-SA-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→GLOSSARY-SCIENCE-CARD |
| GLOSSARY science card | OK | `research/worksheets/GLOSSARY-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→EPI-SCIENCE-CARD |
| EPI science card | OK | `research/worksheets/EPI-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→OMICS-IF-SCIENCE-CARD |
| OMICS-IF science card | OK | `research/worksheets/OMICS-IF-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→INTERIM-G2-SCIENCE-CARD |
| INTERIM-G2 science card | OK | `research/worksheets/INTERIM-G2-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→IMAGEJ-SCIENCE-CARD |
...
| TRIPOD science card | OK | `research/worksheets/TRIPOD-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→ICF-NEST-SCIENCE-CARD |
...
| AI-STACK science card | OK | `research/worksheets/AI-STACK-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→OMICS-GATES-SCIENCE-CARD |
| OMICS-GATES science card | OK | `research/worksheets/OMICS-GATES-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→SYNTH-SCIENCE-CARD |
...
| VAS-LEAK science card | OK | `research/worksheets/VAS-LEAK-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→DEID-MISS-SCIENCE-CARD |
| DEID-MISS science card | OK | `research/worksheets/DEID-MISS-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→ALERT-HAWTHORNE-SCIENCE-CARD |
| ALERT-HAWTHORNE science card | OK | `research/worksheets/ALERT-HAWTHORNE-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→LEAK-CROSS-SCIENCE-CARD |
...
| TRIPOD-SYNTH science card | OK | `research/worksheets/TRIPOD-SYNTH-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→CONSORT-SPIRIT-SCIENCE-CARD |
| CONSORT-SPIRIT science card | OK | `research/worksheets/CONSORT-SPIRIT-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→SHIFT-PB007-SCIENCE-CARD |
...
| SAP-EQ science card | OK | `research/worksheets/SAP-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→AMENDMENT-EQ-SCIENCE-CARD |
| AMENDMENT-EQ science card | OK | `research/worksheets/AMENDMENT-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→TT43-EQ-SCIENCE-CARD |
...
| DEID-EQ science card | OK | `research/worksheets/DEID-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→ISO-SWAB-EQ-SCIENCE-CARD |
| ISO-SWAB-EQ science card | OK | `research/worksheets/ISO-SWAB-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→MISSINGNESS-EQ-SCIENCE-CARD |
| MISSINGNESS-EQ science card | OK | `research/worksheets/MISSINGNESS-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PEA-EQ-SCIENCE-CARD |
| PEA-EQ science card | OK | `research/worksheets/PEA-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PREANALYTIC-EQ-SCIENCE-CARD |
| PREANALYTIC-EQ science card | OK | `research/worksheets/PREANALYTIC-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PEA-PANEL-EQ-SCIENCE-CARD |
| PEA-PANEL-EQ science card | OK | `research/worksheets/PEA-PANEL-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→INTERIM-G2-EQ-SCIENCE-CARD |
| INTERIM-G2-EQ science card | OK | `research/worksheets/INTERIM-G2-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→OMICS-IF-EQ-SCIENCE-CARD |
...
| L1L2L3-EQ science card | OK | `research/worksheets/L1L2L3-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→AI-STACK-EQ-SCIENCE-CARD |
...
| BN-VISIT-EQ science card | OK | `research/worksheets/BN-VISIT-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PB005-EQ-SCIENCE-CARD |
...
| TRIPOD-SYNTH-EQ science card | OK | `research/worksheets/TRIPOD-SYNTH-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PITFALLS-EQ-SCIENCE-CARD |
...
| NATMED-ALERT-EQ science card | OK | `research/worksheets/NATMED-ALERT-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→ALERT-HAWTHORNE-EQ-SCIENCE-CARD |
...
| DEID-MISS-EQ science card | OK | `research/worksheets/DEID-MISS-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→MISS-RESCUE-EQ-SCIENCE-CARD |
| MISS-RESCUE-EQ science card | OK | `research/worksheets/MISS-RESCUE-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→BACKLOG-EQ-SCIENCE-CARD |
| BACKLOG-EQ science card | OK | `research/worksheets/BACKLOG-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→SHIFT-EQ-SCIENCE-CARD |
| SHIFT-EQ science card | OK | `research/worksheets/SHIFT-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→HAWTHORNE-EQ-SCIENCE-CARD |
| HAWTHORNE-EQ science card | OK | `research/worksheets/HAWTHORNE-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→MEDIA-EQ-SCIENCE-CARD |
| MEDIA-EQ science card | OK | `research/worksheets/MEDIA-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→ALERT-EQ-SCIENCE-CARD |
| ALERT-EQ science card | OK | `research/worksheets/ALERT-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→EPI-EQ-SCIENCE-CARD |
| EPI-EQ science card | OK | `research/worksheets/EPI-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→VAS-EQ-SCIENCE-CARD |
| VAS-EQ science card | OK | `research/worksheets/VAS-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PUSH-EQ-SCIENCE-CARD |
| PUSH-EQ science card | OK | `research/worksheets/PUSH-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→CLIN_EVENT-EQ-SCIENCE-CARD |
...
| PB007-EQ science card | OK | `research/worksheets/PB007-EQ-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PB008-EQ-SCIENCE-CARD |
...
| STREAK3-5MIN science card | OK | `research/worksheets/STREAK3-5MIN-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→STREAK3-EQ-5MIN-SCIENCE-CARD |
| STREAK3-EQ-5MIN science card | OK | `research/worksheets/STREAK3-EQ-5MIN-SCIENCE-CARD-v0.1.md` · refresh v0.1b · tip→PI-SESSION-SCRIPT-STREAK3-SCIENCE-CARD |
| Google Daily/Weekly description | OK 2026-09-16 ×366 | STREAK3-EQ-5MIN · STREAK3-5MIN · NatMed |
| GOAL-HEALTH audit | OK | `GOAL-HEALTH.md` · refresh v0.1b · STREAK 2 · ACTIVE · densify≠complete |
| Timer `precure-daily-check` | OK (renewed 2026-09-16) | 07:30 ICT · tip → PI-SESSION-SCRIPT-STREAK3-SCIENCE-CARD · NatMed if STREAK&lt;3 · `sub_8322c4b8-4811-4757-bdf9-9aa5380ae31b` |
...
| CROSS-SA early-signal map | OK | `CROSS-SA-EARLY-SIGNAL-MAP-v0.1.md` · refresh v0.1b · STREAK3 · tip→LEAKAGE |
| EARLY-SIGNAL glossary | OK | `EARLY-SIGNAL-GLOSSARY-v0.1.md` · refresh v0.1b · STREAK3 · tip→CROSS-SA |
| clin_event vignettes | DRAFT | `CLIN_EVENT-CODING-VIGNETTES-v0.1.md` · log 50–56 enrich |
...
| Multi-omics/ES daily drill | DRAFT | `STUDY-SHEET-MULTI-OMICS-ES-DRILL` · EQ rotation T2/T4/T6 · `daily-protocol` |
...
| Daily stack after STREAK≥3 | OK | `DAILY-STACK-AFTER-STREAK3` · refresh v0.1b · tip→STREAK3-NOW-SCIENCE-CARD |
...
| TRIPOD 5′ micro-drill | DRAFT | `TRIPOD-5MIN-MICRO-DRILL` · T5 · trước claim AI |
| PEA 5′ micro-drill | DRAFT | `PEA-5MIN-MICRO-DRILL` · T3 · L3 CLOSED · multi-omics |
...
| Missingness 5′ micro-drill | DRAFT | `MISSINGNESS-5MIN-MICRO-DRILL` · T5 · L2 %miss · demo≠N |
| Media 5′ micro-drill | DRAFT | `MEDIA-5MIN-MICRO-DRILL` · CN/STREAK3 · VDHN vs DOI |
| Synth 5′ micro-drill | DRAFT | `SYNTH-5MIN-MICRO-DRILL` · T4/T5 · demo≠BN |
| SPIRIT 5′ micro-drill | DRAFT | `SPIRIT-5MIN-MICRO-DRILL` · T5 · S1–S3 ES protocol |
| CONSORT 5′ micro-drill | DRAFT | `CONSORT-5MIN-MICRO-DRILL` · T5 · ES≠primary placement |
| TT43 5′ micro-drill | DRAFT | `TT43-5MIN-MICRO-DRILL` · T5 · amendment hooks · PI điền số điều |
| PB-004 5′ micro-drill | DRAFT | `PB004-5MIN-MICRO-DRILL` · T5/T7 · StudyID→visit · consent/PII |
| PB-009 5′ micro-drill | DRAFT | `PB009-5MIN-MICRO-DRILL` · T3/T5 · L1+L2 trước L3 |
| EPI 5′ micro-drill | DRAFT | `EPI-5MIN-MICRO-DRILL` · T2 · PCT/CFU/VAS D0–D7 ≠ D21 |
| VAS 5′ micro-drill | DRAFT | `VAS-5MIN-MICRO-DRILL` · T4 · 0–10 · D1≠VAS_D3 |
| PUSH 5′ micro-drill | DRAFT | `PUSH-5MIN-MICRO-DRILL` · T6 · exudate/TURN trước D14 |
...
| PB-008 5′ micro-drill | DRAFT | `PB008-5MIN-MICRO-DRILL` · T7/T2/CN · participation bias · ≠ primary |
| PB-007 5′ micro-drill | DRAFT | `PB007-5MIN-MICRO-DRILL` · T2/T3/T4/T6/CN · Z rồi X · M4 CLOSED |
| PB-007 equation framework | DRAFT | `PB-007-equation-framework` · khung \(Y\)/\(Z\)/\(X\) gated |
...
| OMICS-GATES 5′ micro-drill | DRAFT | `OMICS-GATES-5MIN-MICRO-DRILL` · T3/T5 · ma trận cổng SA · L3 CLOSED |
| AI-STACK 5′ micro-drill | DRAFT | `AI-STACK-5MIN-MICRO-DRILL` · T3/T5/T7 · L1→L2 trước L3 · early≠app Dx |
...
| ISO-SWAB 5′ micro-drill | DRAFT | `ISO-SWAB-5MIN-MICRO-DRILL` · T5 · irritation+cytotox SKU |
| HAWTHORNE 5′ micro-drill | DRAFT | `HAWTHORNE-5MIN-MICRO-DRILL` · T2/T7/CN · ≠ primary |
| SPIRIT-G1 5′ micro-drill | DRAFT | `SPIRIT-G1-5MIN-MICRO-DRILL` · T5 · nested ethics trước biospecimen |
| ICF-NEST 5′ micro-drill | DRAFT | `ICF-NEST-5MIN-MICRO-DRILL` · T5 · consent tách trước biospecimen |
| AMENDMENT-ES 5′ micro-drill | DRAFT | `AMENDMENT-ES-5MIN-MICRO-DRILL` · T5 · outline ES · không đổi primary |
| ALERT×Hawthorne 5′ micro-drill | DRAFT | `ALERT-HAWTHORNE-5MIN-MICRO-DRILL` · T2/T4/T6/T7/CN · actionable ≠ Dx · ≠ primary |
| SAP-ES 5′ micro-drill | DRAFT | `SAP-ES-5MIN-MICRO-DRILL` · T5 · §7 leakage · 7.1 · ≠ primary |
| TT43×AMEND 5′ micro-drill | DRAFT | `TT43-AMEND-5MIN-MICRO-DRILL` · T5 · số điều · Git ≠ duyệt |
| CONSORT×SPIRIT 5′ micro-drill | DRAFT | `CONSORT-SPIRIT-5MIN-MICRO-DRILL` · T5 · khai·đặt ES · ≠ primary |
| TRIPOD×SYNTH 5′ micro-drill | DRAFT | `TRIPOD-SYNTH-5MIN-MICRO-DRILL` · T4/T5 · AI claim · demo ≠ BN |
| NATMED-ALERT 5′ micro-drill | DRAFT | `NATMED-ALERT-5MIN-MICRO-DRILL` · T2 · actionable map · ≠ Dx · ≠ press |
| EQ-M0M3 5′ micro-drill | DRAFT | `EQ-M0M3-5MIN-MICRO-DRILL` · T2 · ladder M0→M3 · M4 CLOSED |
| IMAGEJ×EPI 5′ micro-drill | DRAFT | `IMAGEJ-EPI-5MIN-MICRO-DRILL` · T2 · QA ảnh · early window |
| DEID×MISS 5′ micro-drill | DRAFT | `DEID-MISS-5MIN-MICRO-DRILL` · T5/T7 · export · %miss · trước AUROC |
| VAS×LEAK 5′ micro-drill | DRAFT | `VAS-LEAK-5MIN-MICRO-DRILL` · T4 · SA-02 · VAS_D3 ≠ early |
| PUSH×ALERT 5′ micro-drill | DRAFT | `PUSH-ALERT-5MIN-MICRO-DRILL` · T6 · SA-05 · components · ≠ app ICU |
| CLIN×BN 5′ micro-drill | DRAFT | `CLIN-BN-5MIN-MICRO-DRILL` · T7 · dọc L1 · de-ID · ≠ Y |
| EQ02-M0M3 5′ micro-drill | DRAFT | `EQ02-M0M3-5MIN-MICRO-DRILL` · T4 · SA-02 ladder · M1 leakage |
| EQ05-M0M3 5′ micro-drill | DRAFT | `EQ05-M0M3-5MIN-MICRO-DRILL` · T6 · SA-05 ladder · PUSH_D14 leakage |
| PB007×EQ 5′ micro-drill | DRAFT | `PB007-EQ-5MIN-MICRO-DRILL` · T2/T4/T6 · Z rồi X · ladder |
| CROSS×EQ 5′ micro-drill | DRAFT | `CROSS-EQ-5MIN-MICRO-DRILL` · T4/T6/CN · schema · không gộp Y |
| TRIPOD×EQ 5′ micro-drill | DRAFT | `TRIPOD-EQ-5MIN-MICRO-DRILL` · T4/T5 · AI claim · demo ≠ BN |
| SHIFT×PB007 5′ micro-drill | DRAFT | `SHIFT-PB007-5MIN-MICRO-DRILL` · mọi thứ · Z rồi X · ≠ copy bank |
| LEAK×CROSS 5′ micro-drill | DRAFT | `LEAK-CROSS-5MIN-MICRO-DRILL` · T4/T6/CN · Y(t*) ≠ early · không gộp Y |
| SAP×EQ 5′ micro-drill | DRAFT | `SAP-EQ-5MIN-MICRO-DRILL` · T5 · §7 leakage · ladder · ≠ primary |
| L1L2L3×SHIFT 5′ micro-drill | DRAFT | `L1L2L3-SHIFT-5MIN-MICRO-DRILL` · T3/T6 · gate · lệch hướng · L3 CLOSED |
| ALERT×CROSS 5′ micro-drill | DRAFT | `ALERT-CROSS-5MIN-MICRO-DRILL` · T2/T4/T6/CN · actionable ≠ Dx · không gộp Y |
| AMENDMENT×EQ 5′ micro-drill | DRAFT | `AMENDMENT-EQ-5MIN-MICRO-DRILL` · T5 · outline · ladder · ≠ primary |
| SPIRIT×EQ 5′ micro-drill | DRAFT | `SPIRIT-EQ-5MIN-MICRO-DRILL` · T5 · S1–S3 · ladder · ≠ protocol xong |
| MEDIA×SHIFT 5′ micro-drill | DRAFT | `MEDIA-SHIFT-5MIN-MICRO-DRILL` · CN · press ≠ DOI · lệch hướng Press |
| CONSORT×EQ 5′ micro-drill | DRAFT | `CONSORT-EQ-5MIN-MICRO-DRILL` · T5 · placement ES · ladder · ≠ primary |
| ICF×EQ 5′ micro-drill | DRAFT | `ICF-EQ-5MIN-MICRO-DRILL` · T5 · consent tách · ladder · trước biospecimen |
| TT43×EQ 5′ micro-drill | DRAFT | `TT43-EQ-5MIN-MICRO-DRILL` · T5 · số điều · ladder · Git ≠ duyệt |
| DEID×EQ 5′ micro-drill | DRAFT | `DEID-EQ-5MIN-MICRO-DRILL` · T5/T7 · export · ladder Z · trước AUROC |
| ISO-SWAB×EQ 5′ micro-drill | DRAFT | `ISO-SWAB-EQ-5MIN-MICRO-DRILL` · T5 · SKU cổng · ladder Z · trước nested |
| PEA×EQ 5′ micro-drill | DRAFT | `PEA-EQ-5MIN-MICRO-DRILL` · T3 · L3 CLOSED · ladder Z · trước X |
| PREANALYTIC×EQ 5′ micro-drill | DRAFT | `PREANALYTIC-EQ-5MIN-MICRO-DRILL` · T3 · R1–R3 · ladder Z · trước G2 |
| PEA-PANEL×EQ 5′ micro-drill | DRAFT | `PEA-PANEL-EQ-5MIN-MICRO-DRILL` · T3 · hẹp ≤20 · ladder Z · trước M4 |
| INTERIM-G2×EQ 5′ micro-drill | DRAFT | `INTERIM-G2-EQ-5MIN-MICRO-DRILL` · T3/T5 · mock · ladder Z · G2 CLOSED |
| OMICS-IF×EQ 5′ micro-drill | DRAFT | `OMICS-IF-EQ-5MIN-MICRO-DRILL` · T3/T5 · skip L3 · ladder Z · G2 CLOSED |
| G2×EQ 5′ micro-drill | DRAFT | `G2-EQ-5MIN-MICRO-DRILL` · T3/T5 · readiness · ladder Z · trước order |
| OMICS-GATES×EQ 5′ micro-drill | DRAFT | `OMICS-GATES-EQ-5MIN-MICRO-DRILL` · T3/T5 · ma trận cổng · ladder Z · L3 CLOSED |
...
| YTESO×EQ 5′ micro-drill | DRAFT | `YTESO-EQ-5MIN-MICRO-DRILL` · T5/T7/CN · ba trụ · ladder Z · không Dx |
| PB004×EQ 5′ micro-drill | DRAFT | `PB004-EQ-5MIN-MICRO-DRILL` · T5/T7 · StudyID→visit · ladder Z · consent/PII |
| BN-VISIT×EQ 5′ micro-drill | DRAFT | `BN-VISIT-EQ-5MIN-MICRO-DRILL` · T7 · StudyID→visits · ladder Z · ≠ PHI |
| PB005×EQ 5′ micro-drill | DRAFT | `PB005-EQ-5MIN-MICRO-DRILL` · T5/CN · biofilm proxy · ladder Z lab · ≠ Dx |
| PB006×EQ 5′ micro-drill | DRAFT | `PB006-EQ-5MIN-MICRO-DRILL` · T5/CN · ISO cổng · ladder Z · L3 CLOSED |
| TRANSLATION×EQ 5′ micro-drill | DRAFT | `TRANSLATION-EQ-5MIN-MICRO-DRILL` · T5/CN · in-vitro→người · ladder Z · ≠ primary |
| SYNTH×EQ 5′ micro-drill | DRAFT | `SYNTH-EQ-5MIN-MICRO-DRILL` · T4/T5 · demo ≠ BN · ladder Z · ≠ AUROC lâm sàng |
| PB008×EQ 5′ micro-drill | DRAFT | `PB008-EQ-5MIN-MICRO-DRILL` · T7/T2/CN · Hawthorne · ladder Z · ≠ primary |
| MEDIA×EQ 5′ micro-drill | DRAFT | `MEDIA-EQ-5MIN-MICRO-DRILL` · CN · press ≠ DOI · ladder Z · ≠ Dx |
| HAWTHORNE×EQ 5′ micro-drill | DRAFT | `HAWTHORNE-EQ-5MIN-MICRO-DRILL` · T2/T7/CN · participation · ladder Z · ≠ primary |
| PB001×EQ 5′ micro-drill | DRAFT | `PB001-EQ-5MIN-MICRO-DRILL` · T2/CN · cờ đầu SA-01 · ladder Z · X CLOSED |
| PB002×EQ 5′ micro-drill | DRAFT | `PB002-EQ-5MIN-MICRO-DRILL` · T4/CN · SA-02 support · ladder Z · ≠ gộp Y |
| GLOSSARY×EQ 5′ micro-drill | DRAFT | `GLOSSARY-EQ-5MIN-MICRO-DRILL` · mọi thứ · nghĩa đúng · ladder Z · ≠ press |
| PB003×EQ 5′ micro-drill | DRAFT | `PB003-EQ-5MIN-MICRO-DRILL` · T6/CN · SA-05 alert · ladder Z · ≠ deploy ICU |
| EPI×EQ 5′ micro-drill | DRAFT | `EPI-EQ-5MIN-MICRO-DRILL` · T2 · SA-01 window · ladder Z · ≠ PCT_D21 |
| VAS×EQ 5′ micro-drill | DRAFT | `VAS-EQ-5MIN-MICRO-DRILL` · T4 · SA-02 0–10 · ladder Z · ≠ VAS_D3 early |
| PUSH×EQ 5′ micro-drill | DRAFT | `PUSH-EQ-5MIN-MICRO-DRILL` · T6 · SA-05 components · ladder Z · ≠ D14 early |
| ALERT×EQ 5′ micro-drill | DRAFT | `ALERT-EQ-5MIN-MICRO-DRILL` · T2/T4/T6 · actionable · ladder Z · ≠ Dx |
| CLIN_EVENT×EQ 5′ micro-drill | DRAFT | `CLIN_EVENT-EQ-5MIN-MICRO-DRILL` · T7 · dọc L1 · ladder Z · ≠ Y |
| LEAKAGE×EQ 5′ micro-drill | DRAFT | `LEAKAGE-EQ-5MIN-MICRO-DRILL` · T4 · timestamp · ladder Z · ≠ AUROC claim |
| IMAGEJ×EQ 5′ micro-drill | DRAFT | `IMAGEJ-EQ-5MIN-MICRO-DRILL` · T2 · PCT QA · ladder Z · ≠ PCT_D21 |
| MISSINGNESS×EQ 5′ micro-drill | DRAFT | `MISSINGNESS-EQ-5MIN-MICRO-DRILL` · T5 · %miss · ladder Z · trước AUROC |
...
| SPIRIT-G1×EQ 5′ micro-drill | DRAFT | `SPIRIT-G1-EQ-5MIN-MICRO-DRILL` · T5 · N1–N5 · ladder Z · ≠ biospecimen |
| DEID-MISS×EQ 5′ micro-drill | DRAFT | `DEID-MISS-EQ-5MIN-MICRO-DRILL` · T5/T7 · %miss · deny-list · ladder Z · trước AUROC |
| VAS-LEAK×EQ 5′ micro-drill | DRAFT | `VAS-LEAK-EQ-5MIN-MICRO-DRILL` · T4 · 0–10 · ladder Z · ≠ VAS_D3 early |
| PUSH-ALERT×EQ 5′ micro-drill | DRAFT | `PUSH-ALERT-EQ-5MIN-MICRO-DRILL` · T6 · components · ladder Z · ≠ D14/app ICU |
| ALERT-HAWTHORNE×EQ 5′ micro-drill | DRAFT | `ALERT-HAWTHORNE-EQ-5MIN-MICRO-DRILL` · T2/T4/T6/T7/CN · actionable · ladder Z · ≠ Dx |
| IMAGEJ-EPI×EQ 5′ micro-drill | DRAFT | `IMAGEJ-EPI-EQ-5MIN-MICRO-DRILL` · T2 · QA+window · ladder Z · ≠ PCT_D21 |
| ALERT-CROSS×EQ 5′ micro-drill | DRAFT | `ALERT-CROSS-EQ-5MIN-MICRO-DRILL` · T2/T4/T6/CN · schema · ladder Z · ≠ Dx |
| MEDIA-SHIFT×EQ 5′ micro-drill | DRAFT | `MEDIA-SHIFT-EQ-5MIN-MICRO-DRILL` · CN · press≠DOI · ladder Z · ≠ Dx |
| L1L2L3-SHIFT×EQ 5′ micro-drill | DRAFT | `L1L2L3-SHIFT-EQ-5MIN-MICRO-DRILL` · T3/T6/CN · gate · ladder Z · L3 CLOSED |
| SHIFT-PB007×EQ 5′ micro-drill | DRAFT | `SHIFT-PB007-EQ-5MIN-MICRO-DRILL` · mọi thứ · Z rồi X · ladder Z |
...
| Zhou × STREAK/T2 science card | OK | `ZHOU-STREAK3-SCIENCE-CARD` · refresh v0.1b · tip→EQ-M0M3-SCIENCE-CARD |
| Y tế số × early-signal science card | OK | `YTESO-EARLY-SIGNAL-SCIENCE-CARD` · refresh v0.1b · tip→ZHOU-STREAK3-SCIENCE-CARD |
...
| ALERT science card | OK | `ALERT-SCIENCE-CARD` · refresh v0.1b · tip→NATMED-STREAK3-SCIENCE-CARD |
| clin_event science card | OK | `CLIN_EVENT-SCIENCE-CARD` · refresh v0.1b · tip→ALERT-SCIENCE-CARD |
| L1→L2→L3 science card | OK | `L1L2L3-SCIENCE-CARD` · refresh v0.1b · tip→CLIN_EVENT-SCIENCE-CARD |
...
| OMICS-GATES science card | OK | `OMICS-GATES-SCIENCE-CARD` · refresh v0.1b · tip→SYNTH-SCIENCE-CARD |
| AI-STACK science card | OK | `AI-STACK-SCIENCE-CARD` · refresh v0.1b · tip→OMICS-GATES-SCIENCE-CARD |
...
| TRIPOD science card | OK | `TRIPOD-SCIENCE-CARD` · refresh v0.1b · tip→ICF-NEST-SCIENCE-CARD |
...
| PB009 science card | OK | `PB009-SCIENCE-CARD` · refresh v0.1b · tip→PB007-SCIENCE-CARD |
| PB008 science card | OK | `PB008-SCIENCE-CARD` · refresh v0.1b · tip→PB009-SCIENCE-CARD |
| STREAK3-PACK science card | OK | `STREAK3-PACK-SCIENCE-CARD` · refresh v0.1b · tip→STREAK3-EQ |
...
| VAS-LEAK science card | OK | `VAS-LEAK-SCIENCE-CARD` · refresh v0.1b · tip→DEID-MISS-SCIENCE-CARD |
| DEID-MISS science card | OK | `DEID-MISS-SCIENCE-CARD` · refresh v0.1b · tip→ALERT-HAWTHORNE-SCIENCE-CARD |
| ALERT-HAWTHORNE science card | OK | `ALERT-HAWTHORNE-SCIENCE-CARD` · refresh v0.1b · tip→LEAK-CROSS-SCIENCE-CARD |
...
| TRIPOD-SYNTH science card | OK | `TRIPOD-SYNTH-SCIENCE-CARD` · refresh v0.1b · tip→CONSORT-SPIRIT-SCIENCE-CARD |
| CONSORT-SPIRIT science card | OK | `CONSORT-SPIRIT-SCIENCE-CARD` · refresh v0.1b · tip→SHIFT-PB007-SCIENCE-CARD |
...
| SAP-EQ science card | OK | `SAP-EQ-SCIENCE-CARD` · refresh v0.1b · tip→AMENDMENT-EQ-SCIENCE-CARD |
| AMENDMENT-EQ science card | OK | `AMENDMENT-EQ-SCIENCE-CARD` · refresh v0.1b · tip→TT43-EQ-SCIENCE-CARD |
...
| DEID-EQ science card | OK | `DEID-EQ-SCIENCE-CARD` · refresh v0.1b · tip→ISO-SWAB-EQ-SCIENCE-CARD |
| ISO-SWAB-EQ science card | OK | `ISO-SWAB-EQ-SCIENCE-CARD` · refresh v0.1b · tip→MISSINGNESS-EQ-SCIENCE-CARD |
| MISSINGNESS-EQ science card | OK | `MISSINGNESS-EQ-SCIENCE-CARD` · refresh v0.1b · tip→PEA-EQ-SCIENCE-CARD |
| PEA-EQ science card | OK | `PEA-EQ-SCIENCE-CARD` · refresh v0.1b · tip→PREANALYTIC-EQ-SCIENCE-CARD |
| PREANALYTIC-EQ science card | OK | `PREANALYTIC-EQ-SCIENCE-CARD` · refresh v0.1b · tip→PEA-PANEL-EQ-SCIENCE-CARD |
| PEA-PANEL-EQ science card | OK | `PEA-PANEL-EQ-SCIENCE-CARD` · refresh v0.1b · tip→INTERIM-G2-EQ-SCIENCE-CARD |
| INTERIM-G2-EQ science card | OK | `INTERIM-G2-EQ-SCIENCE-CARD` · refresh v0.1b · tip→OMICS-IF-EQ-SCIENCE-CARD |
...
| L1L2L3-EQ science card | OK | `L1L2L3-EQ-SCIENCE-CARD` · refresh v0.1b · tip→AI-STACK-EQ-SCIENCE-CARD |
...
| BN-VISIT-EQ science card | OK | `BN-VISIT-EQ-SCIENCE-CARD` · refresh v0.1b · tip→PB005-EQ-SCIENCE-CARD |
...
| TRIPOD-SYNTH-EQ science card | OK | `TRIPOD-SYNTH-EQ-SCIENCE-CARD` · refresh v0.1b · tip→PITFALLS-EQ-SCIENCE-CARD |
...
| NATMED-ALERT-EQ science card | OK | `NATMED-ALERT-EQ-SCIENCE-CARD` · refresh v0.1b · tip→ALERT-HAWTHORNE-EQ-SCIENCE-CARD |
...
| DEID-MISS-EQ science card | OK | `DEID-MISS-EQ-SCIENCE-CARD` · refresh v0.1b · tip→MISS-RESCUE-EQ-SCIENCE-CARD |
| MISS-RESCUE-EQ science card | OK | `MISS-RESCUE-EQ-SCIENCE-CARD` · refresh v0.1b · tip→BACKLOG-EQ-SCIENCE-CARD |
| BACKLOG-EQ science card | OK | `BACKLOG-EQ-SCIENCE-CARD` · refresh v0.1b · tip→SHIFT-EQ-SCIENCE-CARD |
| SHIFT-EQ science card | OK | `SHIFT-EQ-SCIENCE-CARD` · refresh v0.1b · tip→HAWTHORNE-EQ-SCIENCE-CARD |
| HAWTHORNE-EQ science card | OK | `HAWTHORNE-EQ-SCIENCE-CARD` · refresh v0.1b · tip→MEDIA-EQ-SCIENCE-CARD |
| MEDIA-EQ science card | OK | `MEDIA-EQ-SCIENCE-CARD` · refresh v0.1b · tip→ALERT-EQ-SCIENCE-CARD |
| ALERT-EQ science card | OK | `ALERT-EQ-SCIENCE-CARD` · refresh v0.1b · tip→EPI-EQ-SCIENCE-CARD |
| EPI-EQ science card | OK | `EPI-EQ-SCIENCE-CARD` · refresh v0.1b · tip→VAS-EQ-SCIENCE-CARD |
| VAS-EQ science card | OK | `VAS-EQ-SCIENCE-CARD` · refresh v0.1b · tip→PUSH-EQ-SCIENCE-CARD |
| PUSH-EQ science card | OK | `PUSH-EQ-SCIENCE-CARD` · refresh v0.1b · tip→CLIN_EVENT-EQ-SCIENCE-CARD |
...
| PB007-EQ science card | OK | `PB007-EQ-SCIENCE-CARD` · refresh v0.1b · tip→PB008-EQ-SCIENCE-CARD |
...
| EQ-SIBLING-MAP science card | OK | `EQ-SIBLING-MAP-SCIENCE-CARD` · refresh v0.1b · tip→DAILY-STACK-AFTER-STREAK3 |
| DAILY-STACK-AFTER-STREAK3 | OK | `DAILY-STACK-AFTER-STREAK3` · refresh v0.1b · tip→STREAK3-NOW-SCIENCE-CARD |
| STREAK3-NOW science card | OK | `STREAK3-NOW-SCIENCE-CARD` · refresh v0.1b · tip→STREAK3-FILL-AID-SCIENCE-CARD |
| STREAK3-FILL-AID science card | OK | `STREAK3-FILL-AID-SCIENCE-CARD` · refresh v0.1b · tip→STREAK3-5MIN-SCIENCE-CARD |
| STREAK3-5MIN science card | OK | `STREAK3-5MIN-SCIENCE-CARD` · refresh v0.1b · tip→STREAK3-EQ-5MIN-SCIENCE-CARD |
| STREAK3-EQ-5MIN science card | OK | `STREAK3-EQ-5MIN-SCIENCE-CARD` · refresh v0.1b · tip→PI-SESSION-SCRIPT-STREAK3-SCIENCE-CARD |
...
| SPIRIT science card (base) | OK | `SPIRIT-SCIENCE-CARD` · refresh v0.1b · tip→TRANSLATION-SCIENCE-CARD |
| TRANSLATION science card | OK | `TRANSLATION-SCIENCE-CARD` · refresh v0.1b · tip→CROSS-SA-SCIENCE-CARD |
| CROSS-SA science card | OK | `CROSS-SA-SCIENCE-CARD` · refresh v0.1b · tip→GLOSSARY-SCIENCE-CARD |
| GLOSSARY science card | OK | `GLOSSARY-SCIENCE-CARD` · refresh v0.1b · tip→EPI-SCIENCE-CARD |
| EPI science card | OK | `EPI-SCIENCE-CARD` · refresh v0.1b · tip→OMICS-IF-SCIENCE-CARD |
| OMICS-IF science card | OK | `OMICS-IF-SCIENCE-CARD` · refresh v0.1b · tip→INTERIM-G2-SCIENCE-CARD |
| INTERIM-G2 science card | OK | `INTERIM-G2-SCIENCE-CARD` · refresh v0.1b · tip→IMAGEJ-SCIENCE-CARD |
| IMAGEJ science card | OK | `IMAGEJ-SCIENCE-CARD` · refresh v0.1b · tip→PEA-PANEL-SCIENCE-CARD |
...
| SAP-ES science card | OK | `SAP-ES-SCIENCE-CARD` · refresh v0.1b · tip→CONSORT-SCIENCE-CARD |
| CONSORT science card | OK | `CONSORT-SCIENCE-CARD` · refresh v0.1b · tip→TT43-SCIENCE-CARD |
